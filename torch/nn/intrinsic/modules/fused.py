...
class ConvReLU2d(torch.nn.Sequential):
    ...
    def __init__(self, conv, relu):
        assert (type(conv) == Conv2d and type(relu) == ReLU), 'Incorrect types for input modules{}{}'.format(type(conv), type(relu))
...
class LinearReLU(torch.nn.Sequential):
    ...
    def __init__(self, linear, relu):
        assert (type(linear) == Linear and type(relu) == ReLU), 'Incorrect types for input modules{}{}'.format(type(linear), type(relu))
...
class ConvBn2d(torch.nn.Sequential):
    ...
    def __init__(self, conv, bn):
        assert (type(conv) == Conv2d and type(bn) == BatchNorm2d), 'Incorrect types for input modules{}{}'.format(type(conv), type(bn))
...
class ConvBnReLU2d(torch.nn.Sequential):
    ...
    def __init__(self, conv, bn, relu):
        assert (type(conv) == Conv2d and type(bn) == BatchNorm2d and type(relu) == ReLU), 'Incorrect types for input modules{}{}{}'.format(type(conv), type(bn), type(relu))
