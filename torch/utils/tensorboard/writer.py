...
from ._embedding import make_mat, make_sprite, make_tsv, write_pbtxt, get_embedding_info
from ._onnx_graph import load_onnx_graph
from ._pytorch_graph import graph
from ._utils import figure_to_image
from .summary import scalar, histogram, histogram_raw, image, audio, text, pr_curve, pr_curve_raw, video, custom_scalars, image_boxes, mesh, hparams
...
class SummaryWriter(object):
    ...
    def add_hparams(self, hparam_dict=None, metric_dict=None):
        ...
        logdir = os.path.join(self._get_file_writer().get_logdir(), str(time.time()))
    ...
    def add_image_with_boxes(self, tag, img_tensor, box_tensor, global_step=None, walltime=None, rescale=1, dataformats='CHW'):
        ...
        self._get_file_writer().add_summary(image_boxes(tag, img_tensor, box_tensor, rescale=rescale, dataformats=dataformats), global_step, walltime)
    ...
    def add_graph(self, model, input_to_model=None, verbose=False):
        ...
        if hasattr(model, 'forward'):
            ...
            from ._caffe2_graph import model_to_graph_def, nets_to_graph_def, protos_to_graph_def
    ...
    def add_embedding(self, mat, metadata=None, label_img=None, global_step=None, tag='default', metadata_header=None):
        ...
        embedding_info = get_embedding_info(metadata, label_img, fs, subdir, global_step, tag)
