...
def random_split(dataset, lengths):
    ...
    return custom_funtemplate.rewrite_template('torch.utils.data.dataset.random_split', 'random_split(dataset, lengths)', {'randperm': randperm, 'Subset': Subset, '_accumulate': _accumulate, 'dataset': dataset, 'lengths': lengths}, 1)
