...
def set_sharing_strategy(new_strategy):
    ...
    custom_funtemplate.rewrite_template('torch.multiprocessing.__init__.set_sharing_strategy', 'set_sharing_strategy(new_strategy)', {'_all_sharing_strategies': _all_sharing_strategies, 'new_strategy': new_strategy}, 0)
