...
def __allow_nonbracketed_mutation():
    ...
    custom_funtemplate.rewrite_template('torch.backends.__init__.__allow_nonbracketed_mutation', '__allow_nonbracketed_mutation()', {'contextmanager': contextmanager}, 0)
