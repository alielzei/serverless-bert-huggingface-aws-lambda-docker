...
class Independent(Distribution):
    ...
    def __init__(self, base_distribution, reinterpreted_batch_ndims, validate_args=None):
        if reinterpreted_batch_ndims > len(base_distribution.batch_shape):
            raise ValueError('Expected reinterpreted_batch_ndims <= len(base_distribution.batch_shape), actual {} vs {}'.format(reinterpreted_batch_ndims, len(base_distribution.batch_shape)))
