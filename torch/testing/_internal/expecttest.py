...
c", 2)
    ...
    return custom_funtemplate.rewrite_template('torch.testing._internal.expecttest.nth_line', 'nth_line(src, lineno)', {'src': src, 'lineno': lineno}, 1)
...
c", 2)
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('torch.testing._internal.expecttest.nth_eol', 'nth_eol(src, lineno)', {'src': src, 'lineno': lineno}, 1)
...
def escape_trailing_quote(s, quote):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('torch.testing._internal.expecttest.escape_trailing_quote', 'escape_trailing_quote(s, quote)', {'s': s, 'quote': quote}, 1)
...
")[1]
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('torch.testing._internal.expecttest.replace_string_literal', 'replace_string_literal(src, lineno, new_string)', {'string': string, 'nth_eol': nth_eol, 'normalize_nl': normalize_nl, 'ok_for_raw_triple_quoted_string': ok_for_raw_triple_quoted_string, 'escape_trailing_quote': escape_trailing_quote, 'RE_EXPECT': RE_EXPECT, 'src': src, 'lineno': lineno, 'new_string': new_string}, 1)
