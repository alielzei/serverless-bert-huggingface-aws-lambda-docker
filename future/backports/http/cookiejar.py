...
def time2netscape(t=None):
    ...
    return custom_funtemplate.rewrite_template('future.backports.http.cookiejar.time2netscape', 'time2netscape(t=None)', {'datetime': datetime, 'DAYS': DAYS, 'MONTHS': MONTHS, 't': t}, 1)
...
def split_header_words(header_values):
    ...
    >>> split_header_words([r'Basic realm=""fooar""'])
