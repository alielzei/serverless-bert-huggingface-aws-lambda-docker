...
def parse_headers(fp, _class=HTTPMessage):
    ...
    return custom_funtemplate.rewrite_template('future.backports.http.client.parse_headers', 'parse_headers(fp, _class=HTTPMessage)', {'_MAXLINE': _MAXLINE, 'LineTooLong': LineTooLong, '_MAXHEADERS': _MAXHEADERS, 'HTTPException': HTTPException, 'email_parser': email_parser, 'fp': fp, '_class': _class, 'HTTPMessage': HTTPMessage}, 1)
