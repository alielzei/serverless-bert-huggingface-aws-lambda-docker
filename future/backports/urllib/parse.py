...
def urldefrag(url):
    ...
    return custom_funtemplate.rewrite_template('future.backports.urllib.parse.urldefrag', 'urldefrag(url)', {'_coerce_args': _coerce_args, 'urlparse': urlparse, 'urlunparse': urlunparse, 'DefragResult': DefragResult, 'url': url}, 1)
...
def parse_qs(qs, keep_blank_values=False, strict_parsing=False, encoding='utf-8', errors='replace'):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('future.backports.urllib.parse.parse_qs', "parse_qs(qs, keep_blank_values=False, strict_parsing=False, encoding='utf-8', errors='replace')", {'parse_qsl': parse_qsl, 'qs': qs, 'keep_blank_values': keep_blank_values, 'strict_parsing': strict_parsing, 'encoding': encoding, 'errors': errors}, 1)
...
def parse_qsl(qs, keep_blank_values=False, strict_parsing=False, encoding='utf-8', errors='replace'):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('future.backports.urllib.parse.parse_qsl', "parse_qsl(qs, keep_blank_values=False, strict_parsing=False, encoding='utf-8', errors='replace')", {'_coerce_args': _coerce_args, 'unquote': unquote, 'qs': qs, 'keep_blank_values': keep_blank_values, 'strict_parsing': strict_parsing, 'encoding': encoding, 'errors': errors}, 1)
...
def quote_plus(string, safe='', encoding=None, errors=None):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('future.backports.urllib.parse.quote_plus', "quote_plus(string, safe='', encoding=None, errors=None)", {'quote': quote, 'string': string, 'safe': safe, 'encoding': encoding, 'errors': errors}, 1)
...
def urlencode(query, doseq=False, safe='', encoding=None, errors=None):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('future.backports.urllib.parse.urlencode', "urlencode(query, doseq=False, safe='', encoding=None, errors=None)", {'sys': sys, 'raise_with_traceback': raise_with_traceback, 'quote_plus': quote_plus, 'query': query, 'doseq': doseq, 'safe': safe, 'encoding': encoding, 'errors': errors}, 1)
...
def splitnport(host, defport=-1):
    ...
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('future.backports.urllib.parse.splitnport', 'splitnport(host, defport=-1)', {'host': host, 'defport': defport}, 2)
_queryprog = None
