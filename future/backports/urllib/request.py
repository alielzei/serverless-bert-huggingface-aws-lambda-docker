...
def urlopen(url, data=None, timeout=socket._GLOBAL_DEFAULT_TIMEOUT, **_3to2kwargs):
    ...
    return custom_funtemplate.rewrite_template('future.backports.urllib.request.urlopen', 'urlopen(url, data=None, timeout=socket._GLOBAL_DEFAULT_TIMEOUT, **_3to2kwargs)', {'_have_ssl': _have_ssl, 'ssl': ssl, 'HTTPSHandler': HTTPSHandler, 'build_opener': build_opener, 'url': url, 'data': data, 'timeout': timeout, '_3to2kwargs': _3to2kwargs}, 1)
...
def urlretrieve(url, filename=None, reporthook=None, data=None):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('future.backports.urllib.request.urlretrieve', 'urlretrieve(url, filename=None, reporthook=None, data=None)', {'splittype': splittype, 'contextlib': contextlib, 'urlopen': urlopen, 'os': os, 'tempfile': tempfile, '_url_tempfiles': _url_tempfiles, 'ContentTooShortError': ContentTooShortError, 'url': url, 'filename': filename, 'reporthook': reporthook, 'data': data}, 2)

def urlcleanup():
    import custom_funtemplate
    custom_funtemplate.rewrite_template('future.backports.urllib.request.urlcleanup', 'urlcleanup()', {'_url_tempfiles': _url_tempfiles, 'os': os, 'EnvironmentError': EnvironmentError}, 0)
if PY3:
...
def build_opener(*handlers):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('future.backports.urllib.request.build_opener', 'build_opener(*handlers)', {'OpenerDirector': OpenerDirector, 'ProxyHandler': ProxyHandler, 'UnknownHandler': UnknownHandler, 'HTTPHandler': HTTPHandler, 'HTTPDefaultErrorHandler': HTTPDefaultErrorHandler, 'HTTPRedirectHandler': HTTPRedirectHandler, 'FTPHandler': FTPHandler, 'FileHandler': FileHandler, 'HTTPErrorProcessor': HTTPErrorProcessor, 'http_client': http_client, 'HTTPSHandler': HTTPSHandler, 'handlers': handlers}, 1)
...
def noheaders():
    ...
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('future.backports.urllib.request.noheaders', 'noheaders()', {'email': email}, 1)
