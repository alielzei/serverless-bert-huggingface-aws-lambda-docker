...
class Fault(Error):
    ...
    def __repr__(self):
        return '<Fault %s: %r>' % (ensure_new_type(self.faultCode), ensure_new_type(self.faultString))
...
def loads(data, use_datetime=False, use_builtin_types=False):
    ...
    return custom_funtemplate.rewrite_template('future.backports.xmlrpc.client.loads', 'loads(data, use_datetime=False, use_builtin_types=False)', {'getparser': getparser, 'data': data, 'use_datetime': use_datetime, 'use_builtin_types': use_builtin_types}, 2)
...
def gzip_decode(data):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('future.backports.xmlrpc.client.gzip_decode', 'gzip_decode(data)', {'gzip': gzip, 'BytesIO': BytesIO, 'IOError': IOError, 'data': data}, 1)
