...
def resolve_dotted_attribute(obj, attr, allow_dotted_names=True):
    ...
    return custom_funtemplate.rewrite_template('future.backports.xmlrpc.server.resolve_dotted_attribute', 'resolve_dotted_attribute(obj, attr, allow_dotted_names=True)', {'obj': obj, 'attr': attr, 'allow_dotted_names': allow_dotted_names}, 1)
...
class CGIXMLRPCRequestHandler(SimpleXMLRPCDispatcher):
    ...
    def handle_get(self):
        ...
        response = http_server.DEFAULT_ERROR_MESSAGE % {'code': code, 'message': message, 'explain': explain}
