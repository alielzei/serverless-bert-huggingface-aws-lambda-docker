...
def issubset(list1, list2):
    ...
    return custom_funtemplate.rewrite_template('future.types.__init__.issubset', 'issubset(list1, list2)', {'list1': list1, 'list2': list2}, 1)
if utils.PY3:
    import builtins
    ...
    str = builtins.str
    newtypes = {bytes: bytes, dict: dict, int: int, list: list, object: object, range: range, str: str}
    __all__ = ['newtypes']
else:
    from .newbytes import newbytes
    ...
    from .newstr import newstr
    newtypes = {bytes: newbytes, dict: newdict, int: newint, long: newint, list: newlist, object: newobject, range: newrange, str: newbytes, unicode: newstr}
