...
def _is_floaty(expr):
    ...
    return custom_funtemplate.rewrite_template('libfuturize.fixes.fix_division_safe._is_floaty', '_is_floaty(expr)', {'Leaf': Leaf, 'const_re': const_re, 'Node': Node, 'expr': expr}, 1)
