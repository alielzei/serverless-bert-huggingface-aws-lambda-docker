...
class Perluniprops:
    ...
    def __init__(self):
        ...
        self.available_categories = ['Close_Punctuation', 'Currency_Symbol', 'IsAlnum', 'IsAlpha', 'IsLower', 'IsN', 'IsSc', 'IsSo', 'IsUpper', 'Line_Separator', 'Number', 'Open_Punctuation', 'Punctuation', 'Separator', 'Symbol', 'Lowercase_Letter', 'Titlecase_Letter', 'Uppercase_Letter', 'IsPf', 'IsPi', 'CJKSymbols', 'CJK']
    ...
    def chars(self, category=None):
        ...
        They are very useful when porting Perl tokenizers to Python.
            ...
            True
            >>> list(pup.chars('Currency_Symbol'))[:5] == ['$', '¢', '£', '¤', '¥']
            True
...
class NonbreakingPrefixes:
    ...
    def __init__(self):
        ...
        self.available_langs = {'assamese': 'as', 'bengali': 'bn', 'catalan': 'ca', 'czech': 'cs', 'german': 'de', 'greek': 'el', 'english': 'en', 'spanish': 'es', 'estonian': 'et', 'finnish': 'fi', 'french': 'fr', 'irish': 'ga', 'gujarati': 'gu', 'hindi': 'hi', 'hungarian': 'hu', 'icelandic': 'is', 'italian': 'it', 'kannada': 'kn', 'lithuanian': 'lt', 'latvian': 'lv', 'malayalam': 'ml', 'manipuri': 'mni', 'marathi': 'mr', 'dutch': 'nl', 'oriya': 'or', 'punjabi': 'pa', 'polish': 'pl', 'portuguese': 'pt', 'romanian': 'ro', 'russian': 'ru', 'slovak': 'sk', 'slovenian': 'sl', 'swedish': 'sv', 'tamil': 'ta', 'telugu': 'te', 'tetum': 'tdt', 'cantonese': 'yue', 'chinese': 'zh'}
    ...
    def words(self, lang=None, ignore_lines_startswith='#'):
        ...
        if lang in self.available_langs:
            ...
            filenames = ['nonbreaking_prefix.' + v for v in set(self.available_langs.values())]
        else:
