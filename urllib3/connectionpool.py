...
def connection_from_url(url, **kw):
    ...
    return custom_funtemplate.rewrite_template('urllib3.connectionpool.connection_from_url', 'connection_from_url(url, **kw)', {'get_host': get_host, 'port_by_scheme': port_by_scheme, 'HTTPSConnectionPool': HTTPSConnectionPool, 'HTTPConnectionPool': HTTPConnectionPool, 'url': url, 'kw': kw}, 1)
...
def _normalize_host(host, scheme):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('urllib3.connectionpool._normalize_host', '_normalize_host(host, scheme)', {'normalize_host': normalize_host, 'host': host, 'scheme': scheme}, 1)
