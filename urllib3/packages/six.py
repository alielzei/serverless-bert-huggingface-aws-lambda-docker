...
def remove_move(name):
    ...
    custom_funtemplate.rewrite_template('urllib3.packages.six.remove_move', 'remove_move(name)', {'_MovedItems': _MovedItems, 'moves': moves, 'name': name}, 0)
if PY3:
    _meth_func = '__func__'
    _meth_self = '__self__'
...
def with_metaclass(meta, *bases):
    ...
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('urllib3.packages.six.with_metaclass', 'with_metaclass(meta, *bases)', {'sys': sys, 'types': types, 'meta': meta, 'bases': bases}, 1)

def add_metaclass(metaclass):
    """Class decorator for creating a class with a metaclass."""
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('urllib3.packages.six.add_metaclass', 'add_metaclass(metaclass)', {'metaclass': metaclass}, 1)
...
def ensure_str(s, encoding='utf-8', errors='strict'):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('urllib3.packages.six.ensure_str', "ensure_str(s, encoding='utf-8', errors='strict')", {'PY2': PY2, 'text_type': text_type, 'PY3': PY3, 'binary_type': binary_type, 's': s, 'encoding': encoding, 'errors': errors}, 1)
...
def ensure_text(s, encoding='utf-8', errors='strict'):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('urllib3.packages.six.ensure_text', "ensure_text(s, encoding='utf-8', errors='strict')", {'binary_type': binary_type, 'text_type': text_type, 's': s, 'encoding': encoding, 'errors': errors}, 1)
...
def python_2_unicode_compatible(klass):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('urllib3.packages.six.python_2_unicode_compatible', 'python_2_unicode_compatible(klass)', {'PY2': PY2, 'klass': klass}, 1)
__path__ = []
