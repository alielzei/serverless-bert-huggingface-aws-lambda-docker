...
def _default_key_normalizer(key_class, request_context):
    ...
    return custom_funtemplate.rewrite_template('urllib3.poolmanager._default_key_normalizer', '_default_key_normalizer(key_class, request_context)', {'key_class': key_class, 'request_context': request_context}, 1)
