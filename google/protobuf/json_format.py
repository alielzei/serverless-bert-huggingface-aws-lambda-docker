...
def MessageToJson(message, including_default_value_fields=False, preserving_proto_field_name=False, indent=2, sort_keys=False, use_integers_for_enums=False, descriptor_pool=None, float_precision=None, ensure_ascii=True):
...
def _DuplicateChecker(js):
    ...
    return custom_funtemplate.rewrite_template('google.protobuf.json_format._DuplicateChecker', '_DuplicateChecker(js)', {'ParseError': ParseError, 'js': js}, 1)

def _CreateMessageFromTypeUrl(type_url, descriptor_pool):
    """Creates a message from a type URL."""
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('google.protobuf.json_format._CreateMessageFromTypeUrl', '_CreateMessageFromTypeUrl(type_url, descriptor_pool)', {'symbol_database': symbol_database, 'type_url': type_url, 'descriptor_pool': descriptor_pool}, 1)
...
def Parse(text, message, ignore_unknown_fields=False, descriptor_pool=None, max_recursion_depth=100):
  ...
  """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('google.protobuf.json_format.Parse', 'Parse(text, message, ignore_unknown_fields=False, descriptor_pool=None, max_recursion_depth=100)', {'json': json, '_DuplicateChecker': _DuplicateChecker, 'ParseError': ParseError, 'ParseDict': ParseDict, 'text': text, 'message': message, 'ignore_unknown_fields': ignore_unknown_fields, 'descriptor_pool': descriptor_pool, 'max_recursion_depth': max_recursion_depth}, 1)

def ParseDict(js_dict, message, ignore_unknown_fields=False, descriptor_pool=None, max_recursion_depth=100):
  ...
  """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('google.protobuf.json_format.ParseDict', 'ParseDict(js_dict, message, ignore_unknown_fields=False, descriptor_pool=None, max_recursion_depth=100)', {'_Parser': _Parser, 'js_dict': js_dict, 'message': message, 'ignore_unknown_fields': ignore_unknown_fields, 'descriptor_pool': descriptor_pool, 'max_recursion_depth': max_recursion_depth}, 1)
...
class _Parser(object):
    ...
    def _ConvertAnyMessage(self, value, message, path):
        ...
        try:
            ...
            raise ParseError('@type is missing when parsing any message at {0}'.format(path))
        try:
            sub_message = _CreateMessageFromTypeUrl(type_url, self.descriptor_pool)
        except TypeError as e:
        ...
        full_name = message_descriptor.full_name
        if _IsWrapperMessage(message_descriptor):
            self._ConvertWrapperMessage(value['value'], sub_message, '{0}.value'.format(path))
        elif full_name in _WKTJSONMETHODS:
...
def _ConvertScalarFieldValue(value, field, path, require_str=False):
  ...
  """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('google.protobuf.json_format._ConvertScalarFieldValue', '_ConvertScalarFieldValue(value, field, path, require_str=False)', {'_INT_TYPES': _INT_TYPES, '_ConvertInteger': _ConvertInteger, '_FLOAT_TYPES': _FLOAT_TYPES, '_ConvertFloat': _ConvertFloat, 'descriptor': descriptor, '_ConvertBool': _ConvertBool, 'base64': base64, '_UNPAIRED_SURROGATE_PATTERN': _UNPAIRED_SURROGATE_PATTERN, 'ParseError': ParseError, 'value': value, 'field': field, 'path': path, 'require_str': require_str}, 1)
...
def _ConvertInteger(value):
  ...
  """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('google.protobuf.json_format._ConvertInteger', '_ConvertInteger(value)', {'ParseError': ParseError, 'value': value}, 1)

def _ConvertFloat(value, field):
    """Convert an floating point number."""
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('google.protobuf.json_format._ConvertFloat', '_ConvertFloat(value, field)', {'math': math, 'ParseError': ParseError, 'descriptor': descriptor, 'type_checkers': type_checkers, '_NEG_INFINITY': _NEG_INFINITY, '_INFINITY': _INFINITY, '_NAN': _NAN, 'value': value, 'field': field}, 1)
...
def _ConvertBool(value, require_str):
  ...
  """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('google.protobuf.json_format._ConvertBool', '_ConvertBool(value, require_str)', {'ParseError': ParseError, 'value': value, 'require_str': require_str}, 1)
