...
def ToShortestFloat(original):
    ...
    return custom_funtemplate.rewrite_template('google.protobuf.internal.type_checkers.ToShortestFloat', 'ToShortestFloat(original)', {'TruncateToFourByteFloat': TruncateToFourByteFloat, 'original': original}, 1)
...
def GetTypeChecker(field):
  ...
  """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('google.protobuf.internal.type_checkers.GetTypeChecker', 'GetTypeChecker(field)', {'_FieldDescriptor': _FieldDescriptor, 'UnicodeValueChecker': UnicodeValueChecker, 'SupportsOpenEnums': SupportsOpenEnums, '_VALUE_CHECKERS': _VALUE_CHECKERS, 'EnumValueChecker': EnumValueChecker, 'field': field}, 1)
