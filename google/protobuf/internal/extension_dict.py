...
def _VerifyExtensionHandle(message, extension_handle):
    ...
    custom_funtemplate.rewrite_template('google.protobuf.internal.extension_dict._VerifyExtensionHandle', '_VerifyExtensionHandle(message, extension_handle)', {'FieldDescriptor': FieldDescriptor, 'message': message, 'extension_handle': extension_handle}, 0)
  ...
  """
    ...
    def __getitem__(self, extension_handle):
        ...
        if extension_handle.label == FieldDescriptor.LABEL_REPEATED:
            ...
            assert getattr(extension_handle.message_type, '_concrete_class', None), 'Uninitialized concrete class found for field %r (message type %r)' % (extension_handle.full_name, extension_handle.message_type.full_name)
