...
def MessageToString(message, as_utf8=False, as_one_line=False, use_short_repeated_primitives=False, pointy_brackets=False, use_index_order=False, float_format=None, double_format=None, use_field_number=False, descriptor_pool=None, indent=0, message_formatter=None, print_unknown_fields=False, force_colon=False):
  ...
  """
    ...
    return custom_funtemplate.rewrite_template('google.protobuf.text_format.MessageToString', 'MessageToString(message, as_utf8=False, as_one_line=False, use_short_repeated_primitives=False, pointy_brackets=False, use_index_order=False, float_format=None, double_format=None, use_field_number=False, descriptor_pool=None, indent=0, message_formatter=None, print_unknown_fields=False, force_colon=False)', {'TextWriter': TextWriter, '_Printer': _Printer, 'message': message, 'as_utf8': as_utf8, 'as_one_line': as_one_line, 'use_short_repeated_primitives': use_short_repeated_primitives, 'pointy_brackets': pointy_brackets, 'use_index_order': use_index_order, 'float_format': float_format, 'double_format': double_format, 'use_field_number': use_field_number, 'descriptor_pool': descriptor_pool, 'indent': indent, 'message_formatter': message_formatter, 'print_unknown_fields': print_unknown_fields, 'force_colon': force_colon}, 1)

def MessageToBytes(message, **kwargs):
    """Convert protobuf message to encoded text format.  See MessageToString."""
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('google.protobuf.text_format.MessageToBytes', 'MessageToBytes(message, **kwargs)', {'MessageToString': MessageToString, 'message': message, 'kwargs': kwargs}, 1)
...
def _BuildMessageFromTypeName(type_name, descriptor_pool):
  ...
  """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('google.protobuf.text_format._BuildMessageFromTypeName', '_BuildMessageFromTypeName(type_name, descriptor_pool)', {'type_name': type_name, 'descriptor_pool': descriptor_pool}, 1)
...
def _SkipFieldContents(tokenizer):
  ...
  """
    import custom_funtemplate
    custom_funtemplate.rewrite_template('google.protobuf.text_format._SkipFieldContents', '_SkipFieldContents(tokenizer)', {'_SkipFieldValue': _SkipFieldValue, '_SkipFieldMessage': _SkipFieldMessage, 'tokenizer': tokenizer}, 0)
...
def _SkipField(tokenizer):
  ...
  """
    import custom_funtemplate
    custom_funtemplate.rewrite_template('google.protobuf.text_format._SkipField', '_SkipField(tokenizer)', {'_SkipFieldContents': _SkipFieldContents, 'tokenizer': tokenizer}, 0)
...
def _SkipFieldMessage(tokenizer):
  ...
  """
    import custom_funtemplate
    custom_funtemplate.rewrite_template('google.protobuf.text_format._SkipFieldMessage', '_SkipFieldMessage(tokenizer)', {'_SkipField': _SkipField, 'tokenizer': tokenizer}, 0)
...
def _SkipFieldValue(tokenizer):
  ...
  """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('google.protobuf.text_format._SkipFieldValue', '_SkipFieldValue(tokenizer)', {'_TryConsumeInt64': _TryConsumeInt64, '_TryConsumeUint64': _TryConsumeUint64, 'ParseError': ParseError, 'tokenizer': tokenizer}, 1)
...
def _TryConsumeInt64(tokenizer):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('google.protobuf.text_format._TryConsumeInt64', '_TryConsumeInt64(tokenizer)', {'_ConsumeInt64': _ConsumeInt64, 'ParseError': ParseError, 'tokenizer': tokenizer}, 1)
...
def _TryConsumeUint64(tokenizer):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('google.protobuf.text_format._TryConsumeUint64', '_TryConsumeUint64(tokenizer)', {'_ConsumeUint64': _ConsumeUint64, 'ParseError': ParseError, 'tokenizer': tokenizer}, 1)
...
def _ConsumeInteger(tokenizer, is_signed=False, is_long=False):
  ...
  """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('google.protobuf.text_format._ConsumeInteger', '_ConsumeInteger(tokenizer, is_signed=False, is_long=False)', {'ParseInteger': ParseInteger, 'tokenizer': tokenizer, 'is_signed': is_signed, 'is_long': is_long}, 1)
...
def ParseInteger(text, is_signed=False, is_long=False):
  ...
  """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('google.protobuf.text_format.ParseInteger', 'ParseInteger(text, is_signed=False, is_long=False)', {'_ParseAbstractInteger': _ParseAbstractInteger, '_INTEGER_CHECKERS': _INTEGER_CHECKERS, 'text': text, 'is_signed': is_signed, 'is_long': is_long}, 1)
...
def _ParseAbstractInteger(text):
  ...
  """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('google.protobuf.text_format._ParseAbstractInteger', '_ParseAbstractInteger(text)', {'re': re, 'text': text}, 1)
...
def ParseFloat(text):
  ...
  """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('google.protobuf.text_format.ParseFloat', 'ParseFloat(text)', {'_FLOAT_INFINITY': _FLOAT_INFINITY, '_FLOAT_NAN': _FLOAT_NAN, 'text': text}, 1)
...
def ParseBool(text):
  ...
  """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('google.protobuf.text_format.ParseBool', 'ParseBool(text)', {'text': text}, 1)
...
def ParseEnum(field, value):
  ...
  """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('google.protobuf.text_format.ParseEnum', 'ParseEnum(field, value)', {'field': field, 'value': value}, 1)
