...
def _get_next_executor_id():
    ...
    return custom_funtemplate.rewrite_template('joblib.externals.loky.reusable_executor._get_next_executor_id', '_get_next_executor_id()', {'_executor_lock': _executor_lock}, 1)
