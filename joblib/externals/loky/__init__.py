"""The :mod:`loky` module manages a pool of worker that can be re-used across time.
...
from concurrent.futures import ALL_COMPLETED, FIRST_COMPLETED, FIRST_EXCEPTION, CancelledError, Executor, TimeoutError, as_completed, wait
