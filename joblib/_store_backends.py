...
def concurrency_safe_write(object_to_write, filename, write_func):
    ...
    return custom_funtemplate.rewrite_template('joblib._store_backends.concurrency_safe_write', 'concurrency_safe_write(object_to_write, filename, write_func)', {'threading': threading, 'os': os, 'object_to_write': object_to_write, 'filename': filename, 'write_func': write_func}, 1)
