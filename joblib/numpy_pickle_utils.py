...
def _write_fileobject(filename, compress=('zlib', 3)):
    ...
    return custom_funtemplate.rewrite_template('joblib.numpy_pickle_utils._write_fileobject', "_write_fileobject(filename, compress=('zlib', 3))", {'_COMPRESSORS': _COMPRESSORS, '_buffered_write_file': _buffered_write_file, 'filename': filename, 'compress': compress}, 1)
BUFFER_SIZE = 2**18
