...
def _register_dask():
    ...
    custom_funtemplate.rewrite_template('joblib.parallel._register_dask', '_register_dask()', {'register_parallel_backend': register_parallel_backend}, 0)
...
def _get_config_param(param, context_config, key):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('joblib.parallel._get_config_param', '_get_config_param(param, context_config, key)', {'default_parallel_config': default_parallel_config, 'param': param, 'context_config': context_config, 'key': key}, 1)
...
def get_active_backend(prefer=default_parallel_config['prefer'], require=default_parallel_config['require'], verbose=default_parallel_config['verbose']):
    ...
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('joblib.parallel.get_active_backend', "get_active_backend(prefer=default_parallel_config['prefer'], require=default_parallel_config['require'], verbose=default_parallel_config['verbose'])", {'_get_active_backend': _get_active_backend, '_get_config_param': _get_config_param, 'default_parallel_config': default_parallel_config, 'prefer': prefer, 'require': require, 'verbose': verbose}, 2)
...
def _get_active_backend(prefer=default_parallel_config['prefer'], require=default_parallel_config['require'], verbose=default_parallel_config['verbose']):
    """Return the active default backend"""
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('joblib.parallel._get_active_backend', "_get_active_backend(prefer=default_parallel_config['prefer'], require=default_parallel_config['require'], verbose=default_parallel_config['verbose'])", {'_backend': _backend, 'default_parallel_config': default_parallel_config, '_get_config_param': _get_config_param, 'VALID_BACKEND_HINTS': VALID_BACKEND_HINTS, 'VALID_BACKEND_CONSTRAINTS': VALID_BACKEND_CONSTRAINTS, 'BACKENDS': BACKENDS, 'DEFAULT_BACKEND': DEFAULT_BACKEND, 'DEFAULT_THREAD_BACKEND': DEFAULT_THREAD_BACKEND, 'prefer': prefer, 'require': require, 'verbose': verbose}, 2)
...
def cpu_count(only_physical_cores=False):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('joblib.parallel.cpu_count', 'cpu_count(only_physical_cores=False)', {'mp': mp, 'loky': loky, 'only_physical_cores': only_physical_cores}, 1)
...
def _verbosity_filter(index, verbose):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('joblib.parallel._verbosity_filter', '_verbosity_filter(index, verbose)', {'sqrt': sqrt, 'index': index, 'verbose': verbose}, 1)

def delayed(function):
    """Decorator used to capture the arguments of a function."""
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('joblib.parallel.delayed', 'delayed(function)', {'functools': functools, 'function': function}, 3)
...
def register_parallel_backend(name, factory, make_default=False):
    ...
    """
    import custom_funtemplate
    custom_funtemplate.rewrite_template('joblib.parallel.register_parallel_backend', 'register_parallel_backend(name, factory, make_default=False)', {'BACKENDS': BACKENDS, 'name': name, 'factory': factory, 'make_default': make_default}, 0)
...
def effective_n_jobs(n_jobs=-1):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('joblib.parallel.effective_n_jobs', 'effective_n_jobs(n_jobs=-1)', {'get_active_backend': get_active_backend, 'n_jobs': n_jobs}, 1)
