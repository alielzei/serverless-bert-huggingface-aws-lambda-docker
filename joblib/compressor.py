...
def register_compressor(compressor_name, compressor, force=False):
    ...
    custom_funtemplate.rewrite_template('joblib.compressor.register_compressor', 'register_compressor(compressor_name, compressor, force=False)', {'CompressorWrapper': CompressorWrapper, '_COMPRESSORS': _COMPRESSORS, 'compressor_name': compressor_name, 'compressor': compressor, 'force': force}, 0)
