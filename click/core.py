...
def _complete_visible_commands(ctx: 'Context', incomplete: str) -> t.Iterator[t.Tuple[(str, 'Command')]]:
    ...
    custom_funtemplate.rewrite_template('click.core._complete_visible_commands', '_complete_visible_commands(ctx, incomplete)', {'t': t, 'MultiCommand': MultiCommand, 'ctx': ctx, 'incomplete': incomplete, 't': t}, 0)

def _check_multicommand(base_command: 'MultiCommand', cmd_name: str, cmd: 'Command', register: bool = False) -> None:
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('click.core._check_multicommand', '_check_multicommand(base_command, cmd_name, cmd, register=False)', {'MultiCommand': MultiCommand, 'base_command': base_command, 'cmd_name': cmd_name, 'cmd': cmd, 'register': register}, 1)
...
def augment_usage_errors(ctx: 'Context', param: t.Optional['Parameter'] = None) -> t.Iterator[None]:
    ...
    import custom_funtemplate
    custom_funtemplate.rewrite_template('click.core.augment_usage_errors', 'augment_usage_errors(ctx, param=None)', {'BadParameter': BadParameter, 'UsageError': UsageError, 'contextmanager': contextmanager, 'ctx': ctx, 'param': param, 't': t, 't': t}, 0)
...
def iter_params_for_processing(invocation_order: t.Sequence['Parameter'], declaration_order: t.Sequence['Parameter']) -> t.List['Parameter']:
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('click.core.iter_params_for_processing', 'iter_params_for_processing(invocation_order, declaration_order)', {'t': t, 'invocation_order': invocation_order, 'declaration_order': declaration_order, 't': t, 't': t, 't': t}, 2)
...
class Context:
    ...
    def to_info_dict(self) -> t.Dict[(str, t.Any)]:
        ...
        .. versionadded:: 8.0
        """
        return {'command': self.command.to_info_dict(self), 'info_name': self.info_name, 'allow_extra_args': self.allow_extra_args, 'allow_interspersed_args': self.allow_interspersed_args, 'ignore_unknown_options': self.ignore_unknown_options, 'auto_envvar_prefix': self.auto_envvar_prefix}
    ...
    @t.overload
    def invoke(__self, __callback: 't.Callable[..., V]', *args, **kwargs) -> V:
        ...
    
    @t.overload
    def invoke(__self, __callback: 'Command', *args, **kwargs) -> t.Any:
        ...
    
    def invoke(__self, __callback: t.Union[('Command', 't.Callable[..., V]')], *args, **kwargs) -> t.Union[(t.Any, V)]:
    ...
    def forward(__self, __cmd: 'Command', *args, **kwargs) -> t.Any:
...
class BaseCommand:
    ...
    def make_context(self, info_name: t.Optional[str], args: t.List[str], parent: t.Optional[Context] = None, **extra) -> Context:
    ...
    def shell_complete(self, ctx: Context, incomplete: str) -> t.List['CompletionItem']:
        ...
        while ctx.parent is not None:
            ...
            if (isinstance(ctx.command, MultiCommand) and ctx.command.chain):
                results.extend((CompletionItem(name, help=command.get_short_help_str()) for (name, command) in _complete_visible_commands(ctx, incomplete) if name not in ctx.protected_args))
        return results
    
    @t.overload
    def main(self, args: t.Optional[t.Sequence[str]] = None, prog_name: t.Optional[str] = None, complete_var: t.Optional[str] = None, standalone_mode: 'te.Literal[True]' = True, **extra) -> 'te.NoReturn':
        ...
    
    @t.overload
    def main(self, args: t.Optional[t.Sequence[str]] = None, prog_name: t.Optional[str] = None, complete_var: t.Optional[str] = None, standalone_mode: bool = ..., **extra) -> t.Any:
        ...
    
    def main(self, args: t.Optional[t.Sequence[str]] = None, prog_name: t.Optional[str] = None, complete_var: t.Optional[str] = None, standalone_mode: bool = True, windows_expand_args: bool = True, **extra) -> t.Any:
...
class Command(BaseCommand):
    ...
    def to_info_dict(self, ctx: Context) -> t.Dict[(str, t.Any)]:
        ...
        info_dict.update(params=[param.to_info_dict() for param in self.get_params(ctx)], help=self.help, epilog=self.epilog, short_help=self.short_help, hidden=self.hidden, deprecated=self.deprecated)
        return info_dict
    ...
    def shell_complete(self, ctx: Context, incomplete: str) -> t.List['CompletionItem']:
        ...
        if (incomplete and not incomplete[0].isalnum()):
            for param in self.get_params(ctx):
                if (not isinstance(param, Option) or param.hidden or (not param.multiple and ctx.get_parameter_source(param.name) is ParameterSource.COMMANDLINE)):
                    continue
                results.extend((CompletionItem(name, help=param.help) for name in [*param.opts, *param.secondary_opts] if name.startswith(incomplete)))
...
class MultiCommand(Command):
    ...
    def __init__(self, name: t.Optional[str] = None, invoke_without_command: bool = False, no_args_is_help: t.Optional[bool] = None, subcommand_metavar: t.Optional[str] = None, chain: bool = False, result_callback: t.Optional[t.Callable[(..., t.Any)]] = None, **attrs) -> None:
...
class Group(MultiCommand):
    ...
    def __init__(self, name: t.Optional[str] = None, commands: t.Optional[t.Union[(t.MutableMapping[(str, Command)], t.Sequence[Command])]] = None, **attrs) -> None:
        super().__init__(name, **attrs)
        if commands is None:
            commands = {}
    ...
    @t.overload
    def command(self, *args, **kwargs) -> t.Callable[([t.Callable[(..., t.Any)]], Command)]:
        ...
    
    def command(self, *args, **kwargs) -> t.Union[(t.Callable[([t.Callable[(..., t.Any)]], Command)], Command)]:
    ...
    @t.overload
    def group(self, *args, **kwargs) -> t.Callable[([t.Callable[(..., t.Any)]], 'Group')]:
        ...
    
    def group(self, *args, **kwargs) -> t.Union[(t.Callable[([t.Callable[(..., t.Any)]], 'Group')], 'Group')]:
...
class CommandCollection(MultiCommand):
    ...
    def __init__(self, name: t.Optional[str] = None, sources: t.Optional[t.List[MultiCommand]] = None, **attrs) -> None:
        super().__init__(name, **attrs)
...
def _check_iter(value: t.Any) -> t.Iterator[t.Any]:
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('click.core._check_iter', '_check_iter(value)', {'value': value, 't': t, 't': t}, 1)
...
class Parameter:
    ...
    def to_info_dict(self) -> t.Dict[(str, t.Any)]:
        ...
        .. versionadded:: 8.0
        """
        return {'name': self.name, 'param_type_name': self.param_type_name, 'opts': self.opts, 'secondary_opts': self.secondary_opts, 'type': self.type.to_info_dict(), 'required': self.required, 'nargs': self.nargs, 'multiple': self.multiple, 'default': self.default, 'envvar': self.envvar}
    
    def __repr__(self) -> str:
        return f'<{self.__class__.__name__} {self.name}>'
    
    def _parse_decls(self, decls: t.Sequence[str], expose_value: bool) -> t.Tuple[(t.Optional[str], t.List[str], t.List[str])]:
        raise NotImplementedError()
...
class Option(Parameter):
    ...
    def __init__(self, param_decls: t.Optional[t.Sequence[str]] = None, show_default: t.Union[(bool, str, None)] = None, prompt: t.Union[(bool, str)] = False, confirmation_prompt: t.Union[(bool, str)] = False, prompt_required: bool = True, hide_input: bool = False, is_flag: t.Optional[bool] = None, flag_value: t.Optional[t.Any] = None, multiple: bool = False, count: bool = False, allow_from_autoenv: bool = True, type: t.Optional[t.Union[(types.ParamType, t.Any)]] = None, help: t.Optional[str] = None, hidden: bool = False, show_choices: bool = True, show_envvar: bool = False, **attrs) -> None:
        if help:
    ...
    def to_info_dict(self) -> t.Dict[(str, t.Any)]:
        ...
        info_dict.update(help=self.help, prompt=self.prompt, is_flag=self.is_flag, flag_value=self.flag_value, count=self.count, hidden=self.hidden)
        return info_dict
    ...
    def _parse_decls(self, decls: t.Sequence[str], expose_value: bool) -> t.Tuple[(t.Optional[str], t.List[str], t.List[str])]:
        ...
        if (not opts and not secondary_opts):
            raise TypeError(f"No options defined but a name was passed ({name}). Did you mean to declare an argument instead? Did you mean to pass '--{name}'?")
    ...
    def add_to_parser(self, parser: OptionParser, ctx: Context) -> None:
        ...
        if self.is_flag:
            ...
            if (self.is_bool_flag and self.secondary_opts):
                ...
                parser.add_option(obj=self, opts=self.secondary_opts, dest=self.name, action=action, const=False)
            else:
                parser.add_option(obj=self, opts=self.opts, dest=self.name, action=action, const=self.flag_value)
        else:
            parser.add_option(obj=self, opts=self.opts, dest=self.name, action=action, nargs=self.nargs)
    ...
    def get_help_record(self, ctx: Context) -> t.Optional[t.Tuple[(str, str)]]:
        ...
        if (isinstance(self.type, types._NumberRangeBase) and not ((self.count and self.type.min == 0 and self.type.max is None))):
    ...
    def consume_value(self, ctx: Context, opts: t.Mapping[(str, 'Parameter')]) -> t.Tuple[(t.Any, ParameterSource)]:
        ...
        if value is _flag_needs_value:
            ...
            source = ParameterSource.COMMANDLINE
        elif (source in {None, ParameterSource.DEFAULT} and self.prompt is not None and ((self.required or self.prompt_required)) and not ctx.resilient_parsing):
            value = self.prompt_for_value(ctx)
            source = ParameterSource.PROMPT
        return (value, source)
...
class Argument(Parameter):
    ...
    def __init__(self, param_decls: t.Sequence[str], required: t.Optional[bool] = None, **attrs) -> None:
        if required is None:
    ...
    def _parse_decls(self, decls: t.Sequence[str], expose_value: bool) -> t.Tuple[(t.Optional[str], t.List[str], t.List[str])]:
        ...
        if len(decls) == 1:
            ...
            raise TypeError(f'Arguments take exactly one parameter declaration, got {len(decls)}.')
        return (name, [arg], [])
