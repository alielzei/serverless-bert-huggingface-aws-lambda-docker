...
def _environ_cols_wrapper():
    ...
    return custom_funtemplate.rewrite_template('tqdm.utils._environ_cols_wrapper', '_environ_cols_wrapper()', {'warn': warn, '_screen_shape_wrapper': _screen_shape_wrapper, 'wraps': wraps}, 1)
