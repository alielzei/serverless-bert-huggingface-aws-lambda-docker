        ...
        def inner_generator(df_function='apply'):
            ...
            def inner(df, func, *args, **kwargs):
                ...
                **kwargs  : optional
                ...
                return custom_funtemplate.rewrite_template('tqdm.std.tqdm.pandas.inner_generator.inner', 'inner(df, func, *args, **kwargs)', {'tqdm_kwargs': tqdm_kwargs, 'df_function': df_function, 'Series': Series, '_Rolling_and_Expanding': _Rolling_and_Expanding, 'deprecated_t': deprecated_t, 'cls': cls, 'TqdmDeprecationWarning': TqdmDeprecationWarning, 'sys': sys, 'df': df, 'func': func, 'args': args, 'kwargs': kwargs}, 1)
            return inner
