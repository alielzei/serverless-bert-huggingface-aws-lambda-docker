from tokenizers import Tokenizer, AddedToken, pre_tokenizers, decoders, trainers, normalizers
import os
...
class SentencePieceUnigramTokenizer(BaseTokenizer):
    ...
    def __init__(self, vocab: Optional[str] = None, replacement: str = '▁', add_prefix_space: bool = True):
    ...
    def train(self, files: Union[(str, List[str])], vocab_size: int = 8000, show_progress: bool = True, special_tokens: List[Union[(str, AddedToken)]] = []):
        """ Train the model using the given files """
        trainer = trainers.UnigramTrainer(vocab_size=vocab_size, special_tokens=special_tokens, show_progress=show_progress)
