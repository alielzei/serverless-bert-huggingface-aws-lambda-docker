...
class BaseFileLock(ABC, contextlib.ContextDecorator):
    ...
    def __new__(cls, lock_file: str | os.PathLike[str], timeout: float = -1, mode: int = 420, thread_local: bool = True, *, is_singleton: bool = False, **kwargs) -> Self:
    ...
    def __init__(self, lock_file: str | os.PathLike[str], timeout: float = -1, mode: int = 420, thread_local: bool = True, *, is_singleton: bool = False) -> None:
        """
        ...
        kwargs: dict[(str, Any)] = {'lock_file': os.fspath(lock_file), 'timeout': timeout, 'mode': mode}
