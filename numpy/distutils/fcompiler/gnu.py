...
def _can_target(cmd, arch):
    ...
    return custom_funtemplate.rewrite_template('numpy.distutils.fcompiler.gnu._can_target', '_can_target(cmd, arch)', {'tempfile': tempfile, 'os': os, 'Popen': Popen, 'STDOUT': STDOUT, 'PIPE': PIPE, 'cmd': cmd, 'arch': arch}, 1)
