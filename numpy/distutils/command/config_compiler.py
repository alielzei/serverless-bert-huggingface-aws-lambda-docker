...
def show_fortran_compilers(_cache=None):
    ...
    return custom_funtemplate.rewrite_template('numpy.distutils.command.config_compiler.show_fortran_compilers', 'show_fortran_compilers(_cache=None)', {'distutils': distutils, '_cache': _cache}, 1)
