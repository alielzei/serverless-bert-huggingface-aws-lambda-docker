...
def subst_vars(target, source, d):
    ...
    custom_funtemplate.rewrite_template('numpy.distutils.command.build_src.subst_vars', 'subst_vars(target, source, d)', {'re': re, 'target': target, 'source': source, 'd': d}, 0)
...
def get_swig_target(source):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('numpy.distutils.command.build_src.get_swig_target', 'get_swig_target(source)', {'_has_cpp_header': _has_cpp_header, '_has_c_header': _has_c_header, 'source': source}, 1)

def get_swig_modulename(source):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('numpy.distutils.command.build_src.get_swig_modulename', 'get_swig_modulename(source)', {'_swig_module_name_match': _swig_module_name_match, 'source': source}, 1)

def _find_swig_target(target_dir, name):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('numpy.distutils.command.build_src._find_swig_target', '_find_swig_target(target_dir, name)', {'os': os, 'target_dir': target_dir, 'name': name}, 1)
...
def get_f2py_modulename(source):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('numpy.distutils.command.build_src.get_f2py_modulename', 'get_f2py_modulename(source)', {'_f2py_module_name_match': _f2py_module_name_match, '_f2py_user_module_name_match': _f2py_user_module_name_match, 'source': source}, 1)
