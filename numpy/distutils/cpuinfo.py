...
def getoutput(cmd, successful_status=(0, ), stacklevel=1):
    ...
    return custom_funtemplate.rewrite_template('numpy.distutils.cpuinfo.getoutput', 'getoutput(cmd, successful_status=(0, ), stacklevel=1)', {'getstatusoutput': getstatusoutput, 'warnings': warnings, 'os': os, 'cmd': cmd, 'successful_status': successful_status, 'stacklevel': stacklevel}, 2)

def command_info(successful_status=(0, ), stacklevel=1, **kw):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('numpy.distutils.cpuinfo.command_info', 'command_info(successful_status=(0, ), stacklevel=1, **kw)', {'getoutput': getoutput, 'successful_status': successful_status, 'stacklevel': stacklevel, 'kw': kw}, 1)

def command_by_line(cmd, successful_status=(0, ), stacklevel=1):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('numpy.distutils.cpuinfo.command_by_line', 'command_by_line(cmd, successful_status=(0, ), stacklevel=1)', {'getoutput': getoutput, 'cmd': cmd, 'successful_status': successful_status, 'stacklevel': stacklevel}, 1)

def key_value_from_command(cmd, sep, successful_status=(0, ), stacklevel=1):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('numpy.distutils.cpuinfo.key_value_from_command', 'key_value_from_command(cmd, sep, successful_status=(0, ), stacklevel=1)', {'command_by_line': command_by_line, 'cmd': cmd, 'sep': sep, 'successful_status': successful_status, 'stacklevel': stacklevel}, 1)
