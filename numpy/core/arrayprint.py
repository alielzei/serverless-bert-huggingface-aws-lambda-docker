...
def set_printoptions(precision=None, threshold=None, edgeitems=None, linewidth=None, suppress=None, nanstr=None, infstr=None, formatter=None, sign=None, floatmode=None, *, legacy=None):
    ...
    custom_funtemplate.rewrite_template('numpy.core.arrayprint.set_printoptions', 'set_printoptions(precision=None, threshold=None, edgeitems=None, linewidth=None, suppress=None, nanstr=None, infstr=None, formatter=None, sign=None, floatmode=None, legacy=None)', {'_make_options_dict': _make_options_dict, '_format_options': _format_options, 'set_legacy_print_mode': set_legacy_print_mode, 'sys': sys, 'set_module': set_module, 'precision': precision, 'threshold': threshold, 'edgeitems': edgeitems, 'linewidth': linewidth, 'suppress': suppress, 'nanstr': nanstr, 'infstr': infstr, 'formatter': formatter, 'sign': sign, 'floatmode': floatmode, 'legacy': legacy}, 0)
...
def printoptions(*args, **kwargs):
    ...
    """
    import custom_funtemplate
    custom_funtemplate.rewrite_template('numpy.core.arrayprint.printoptions', 'printoptions(*args, **kwargs)', {'np': np, 'set_module': set_module, 'contextlib': contextlib, 'args': args, 'kwargs': kwargs}, 0)
...
def array2string(a, max_line_width=None, precision=None, suppress_small=None, separator=' ', prefix='', style=np._NoValue, formatter=None, threshold=None, edgeitems=None, sign=None, floatmode=None, suffix='', *, legacy=None):
    ...
    if options['legacy'] <= 113:
        ...
        warnings.warn("'style' argument is deprecated and no longer functional except in 1.13 'legacy' mode", DeprecationWarning, stacklevel=3)
    if options['legacy'] > 113:
...
def format_float_scientific(x, precision=None, unique=True, trim='k', sign=False, pad_left=None, exp_digits=None, min_digits=None):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('numpy.core.arrayprint.format_float_scientific', "format_float_scientific(x, precision=None, unique=True, trim='k', sign=False, pad_left=None, exp_digits=None, min_digits=None)", {'_none_or_positive_arg': _none_or_positive_arg, 'dragon4_scientific': dragon4_scientific, 'set_module': set_module, 'x': x, 'precision': precision, 'unique': unique, 'trim': trim, 'sign': sign, 'pad_left': pad_left, 'exp_digits': exp_digits, 'min_digits': min_digits}, 1)
...
def format_float_positional(x, precision=None, unique=True, fractional=True, trim='k', sign=False, pad_left=None, pad_right=None, min_digits=None):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('numpy.core.arrayprint.format_float_positional', "format_float_positional(x, precision=None, unique=True, fractional=True, trim='k', sign=False, pad_left=None, pad_right=None, min_digits=None)", {'_none_or_positive_arg': _none_or_positive_arg, 'dragon4_positional': dragon4_positional, 'set_module': set_module, 'x': x, 'precision': precision, 'unique': unique, 'fractional': fractional, 'trim': trim, 'sign': sign, 'pad_left': pad_left, 'pad_right': pad_right, 'min_digits': min_digits}, 1)
