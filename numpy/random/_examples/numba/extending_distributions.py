...
umpy\core\include     -I%PYTHON_HOME%\include %PYTHON_HOME%\libs\python%PYTHON_VERSION%.lib
...
def normals(n, bit_generator):
    ...
    return custom_funtemplate.rewrite_template('numpy.random._examples.numba.extending_distributions.normals', 'normals(n, bit_generator)', {'np': np, 'random_standard_normal': random_standard_normal, 'n': n, 'bit_generator': bit_generator}, 1)
