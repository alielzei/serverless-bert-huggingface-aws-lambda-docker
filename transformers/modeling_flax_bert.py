...
class FlaxBertEmbeddings(nn.Module):
    ...
    def __call__(self, input_ids, token_type_ids, position_ids, attention_mask):
        w_emb = FlaxBertEmbedding(self.vocab_size, self.hidden_size, name='word_embeddings')(jnp.atleast_2d(input_ids.astype('i4')))
        p_emb = FlaxBertEmbedding(self.max_length, self.hidden_size, name='position_embeddings')(jnp.atleast_2d(position_ids.astype('i4')))
        t_emb = FlaxBertEmbedding(self.type_vocab_size, self.hidden_size, name='token_type_embeddings')(jnp.atleast_2d(token_type_ids.astype('i4')))
...
class FlaxBertEncoder(nn.Module):
    ...
    @compact
    def __call__(self, hidden_state, attention_mask):
        layer = FlaxBertLayerCollection(self.num_layers, self.num_heads, self.head_size, self.intermediate_size, name='layer')(hidden_state, attention_mask)
        return layer
...
class FlaxBertModule(nn.Module):
    ...
    @compact
    def __call__(self, input_ids, token_type_ids, position_ids, attention_mask):
        embeddings = FlaxBertEmbeddings(self.vocab_size, self.hidden_size, self.type_vocab_size, self.max_length, name='embeddings')(input_ids, token_type_ids, position_ids, attention_mask)
        encoder = FlaxBertEncoder(self.num_encoder_layers, self.num_heads, self.head_size, self.intermediate_size, name='encoder')(embeddings, attention_mask)
