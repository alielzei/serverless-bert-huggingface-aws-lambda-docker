...
def create_sinusoidal_embeddings(n_pos, dim, out):
    ...
    custom_funtemplate.rewrite_template('transformers.modeling_distilbert.create_sinusoidal_embeddings', 'create_sinusoidal_embeddings(n_pos, dim, out)', {'np': np, 'torch': torch, 'n_pos': n_pos, 'dim': dim, 'out': out}, 0)
...
class DistilBertModel(DistilBertPreTrainedModel):
    ...
    def forward(self, input_ids=None, attention_mask=None, head_mask=None, inputs_embeds=None, output_attentions=None, output_hidden_states=None, return_dict=None):
        ...
        return self.transformer(x=inputs_embeds, attn_mask=attention_mask, head_mask=head_mask, output_attentions=output_attentions, output_hidden_states=output_hidden_states, return_dict=return_dict)
...
class DistilBertForMaskedLM(DistilBertPreTrainedModel):
    ...
    def forward(self, input_ids=None, attention_mask=None, head_mask=None, inputs_embeds=None, labels=None, output_attentions=None, output_hidden_states=None, return_dict=None, **kwargs):
        """
...
class DistilBertForQuestionAnswering(DistilBertPreTrainedModel):
    ...
    def forward(self, input_ids=None, attention_mask=None, head_mask=None, inputs_embeds=None, start_positions=None, end_positions=None, output_attentions=None, output_hidden_states=None, return_dict=None):
        """
