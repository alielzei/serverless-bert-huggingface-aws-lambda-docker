...
class MBartTokenizer(XLMRobertaTokenizer):
    ...
    def prepare_seq2seq_batch(self, src_texts: List[str], src_lang: str = 'en_XX', tgt_texts: Optional[List[str]] = None, tgt_lang: str = 'ro_RO', max_length: Optional[int] = None, max_target_length: Optional[int] = None, truncation: bool = True, padding: str = 'longest', return_tensors: str = 'pt', add_prefix_space: bool = False, **kwargs) -> BatchEncoding:
