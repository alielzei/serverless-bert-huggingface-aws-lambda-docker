...
MBART_PRETRAINED_CONFIG_ARCHIVE_MAP = {'facebook/mbart-large-en-ro': 'https://s3.amazonaws.com/models.huggingface.co/bert/facebook/mbart-large-en-ro/config.json', 'facebook/mbart-large-cc25': 'https://s3.amazonaws.com/models.huggingface.co/bert/facebook/mbart-large-cc25/config.json'}
