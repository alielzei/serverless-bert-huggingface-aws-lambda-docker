...
def format_time(t):
    ...
    return custom_funtemplate.rewrite_template('transformers.utils.notebook.format_time', 'format_time(t)', {'t': t}, 1)
...
def text_to_html_table(items):
    ...
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('transformers.utils.notebook.text_to_html_table', 'text_to_html_table(items)', {'items': items}, 1)
