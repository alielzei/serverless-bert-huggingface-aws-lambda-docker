...
from .modeling_outputs import BaseModelOutput, BaseModelOutputWithPooling, CausalLMOutput, MaskedLMOutput, MultipleChoiceModelOutput, QuestionAnsweringModelOutput, SequenceClassifierOutput, TokenClassifierOutput
...
class RobertaForMultipleChoice(RobertaPreTrainedModel):
    ...
    def forward(self, input_ids=None, token_type_ids=None, attention_mask=None, labels=None, position_ids=None, head_mask=None, inputs_embeds=None, output_attentions=None, output_hidden_states=None, return_dict=None):
        """
        labels (:obj:`torch.LongTensor` of shape :obj:`(batch_size,)`, `optional`):
...
def create_position_ids_from_input_ids(input_ids, padding_idx):
    ...
    return custom_funtemplate.rewrite_template('transformers.modeling_roberta.create_position_ids_from_input_ids', 'create_position_ids_from_input_ids(input_ids, padding_idx)', {'torch': torch, 'input_ids': input_ids, 'padding_idx': padding_idx}, 1)
