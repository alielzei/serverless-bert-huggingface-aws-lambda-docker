...
class GPT2TokenizerFast(PreTrainedTokenizerFast):
    ...
    def __init__(self, vocab_file, merges_file, tokenizer_file=None, unk_token='<|endoftext|>', bos_token='<|endoftext|>', eos_token='<|endoftext|>', add_prefix_space=False, **kwargs):
