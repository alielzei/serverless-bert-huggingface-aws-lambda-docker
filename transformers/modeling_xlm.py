...
from .modeling_utils import PreTrainedModel, SequenceSummary, SQuADHead, apply_chunking_to_forward, find_pruneable_heads_and_indices, prune_linear_layer
...
def create_sinusoidal_embeddings(n_pos, dim, out):
    ...
    custom_funtemplate.rewrite_template('transformers.modeling_xlm.create_sinusoidal_embeddings', 'create_sinusoidal_embeddings(n_pos, dim, out)', {'np': np, 'torch': torch, 'n_pos': n_pos, 'dim': dim, 'out': out}, 0)
...
def get_masks(slen, lengths, causal, padding_mask=None):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('transformers.modeling_xlm.get_masks', 'get_masks(slen, lengths, causal, padding_mask=None)', {'torch': torch, 'slen': slen, 'lengths': lengths, 'causal': causal, 'padding_mask': padding_mask}, 2)
...
class XLMWithLMHeadModel(XLMPreTrainedModel):
    ...
    def forward(self, input_ids=None, attention_mask=None, langs=None, token_type_ids=None, position_ids=None, lengths=None, cache=None, head_mask=None, inputs_embeds=None, labels=None, output_attentions=None, output_hidden_states=None, return_dict=None):
        """
...
class XLMForQuestionAnsweringSimple(XLMPreTrainedModel):
    ...
    def forward(self, input_ids=None, attention_mask=None, langs=None, token_type_ids=None, position_ids=None, lengths=None, cache=None, head_mask=None, inputs_embeds=None, start_positions=None, end_positions=None, output_attentions=None, output_hidden_states=None, return_dict=None):
        """
