...
from .modeling_utils import PreTrainedModel, SequenceSummary, apply_chunking_to_forward, find_pruneable_heads_and_indices, prune_linear_layer
...
def load_tf_weights_in_electra(model, config, tf_checkpoint_path, discriminator_or_generator='discriminator'):
    ...
    return custom_funtemplate.rewrite_template('transformers.modeling_electra.load_tf_weights_in_electra', "load_tf_weights_in_electra(model, config, tf_checkpoint_path, discriminator_or_generator='discriminator')", {'logger': logger, 'os': os, 'ElectraForMaskedLM': ElectraForMaskedLM, 'torch': torch, 'model': model, 'config': config, 'tf_checkpoint_path': tf_checkpoint_path, 'discriminator_or_generator': discriminator_or_generator}, 1)
...
class ElectraPreTrainedModel(PreTrainedModel):
    ...
    authorized_unexpected_keys = ['electra\\.embeddings_project\\.weight', 'electra\\.embeddings_project\\.bias']
...
class ElectraForSequenceClassification(ElectraPreTrainedModel):
    ...
    def forward(self, input_ids=None, attention_mask=None, token_type_ids=None, position_ids=None, head_mask=None, inputs_embeds=None, labels=None, output_attentions=None, output_hidden_states=None, return_dict=None):
        ...
        """
        return_dict = (return_dict if return_dict is not None else self.config.use_return_dict)
        discriminator_hidden_states = self.electra(input_ids, attention_mask, token_type_ids, position_ids, head_mask, inputs_embeds, output_attentions, output_hidden_states, return_dict)
...
class ElectraForMaskedLM(ElectraPreTrainedModel):
    ...
    def forward(self, input_ids=None, attention_mask=None, token_type_ids=None, position_ids=None, head_mask=None, inputs_embeds=None, labels=None, output_attentions=None, output_hidden_states=None, return_dict=None, **kwargs):
        ...
        return_dict = (return_dict if return_dict is not None else self.config.use_return_dict)
        generator_hidden_states = self.electra(input_ids, attention_mask, token_type_ids, position_ids, head_mask, inputs_embeds, output_attentions, output_hidden_states, return_dict)
