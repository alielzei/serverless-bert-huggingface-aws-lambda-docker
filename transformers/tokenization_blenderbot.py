...
class BlenderbotTokenizer(RobertaTokenizer):
    ...
    pretrained_vocab_files_map = {'vocab_file': {CKPT_3B: 'https://cdn.huggingface.co/facebook/blenderbot-3B/vocab.json'}, 'merges_file': {CKPT_3B: 'https://cdn.huggingface.co/facebook/blenderbot-3B/merges.txt'}, 'tokenizer_config_file': {CKPT_3B: 'https://cdn.huggingface.co/facebook/blenderbot-3B/tokenizer_config.json'}}
...
def get_pairs(word):
    ...
    return custom_funtemplate.rewrite_template('transformers.tokenization_blenderbot.get_pairs', 'get_pairs(word)', {'word': word}, 1)
...
class BlenderbotSmallTokenizer(PreTrainedTokenizer):
    ...
    """
    vocab_files_names = {'vocab_file': 'vocab.json', 'merges_file': 'merges.txt'}
    pretrained_vocab_files_map = {'vocab_file': {'facebook/blenderbot-90M': 'https://cdn.huggingface.co/facebook/blenderbot-90M/vocab.json'}, 'merges_file': {'facebook/blenderbot-90M': 'https://cdn.huggingface.co/facebook/blenderbot-90M/merges.txt'}}
