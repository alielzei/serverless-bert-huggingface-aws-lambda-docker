...
from .file_utils import MULTIPLE_CHOICE_DUMMY_INPUTS, ModelOutput, add_code_sample_docstrings, add_start_docstrings, add_start_docstrings_to_callable
...
from .modeling_tf_utils import TFMultipleChoiceLoss, TFPreTrainedModel, TFQuestionAnsweringLoss, TFSequenceClassificationLoss, TFSequenceSummary, TFSharedEmbeddings, TFTokenClassificationLoss, get_initializer, keras_serializable, shape_list
...
def create_sinusoidal_embeddings(n_pos, dim, out):
    ...
    custom_funtemplate.rewrite_template('transformers.modeling_tf_xlm.create_sinusoidal_embeddings', 'create_sinusoidal_embeddings(n_pos, dim, out)', {'np': np, 'tf': tf, 'n_pos': n_pos, 'dim': dim, 'out': out}, 0)
...
def get_masks(slen, lengths, causal, padding_mask=None, dtype=tf.float32):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('transformers.modeling_tf_xlm.get_masks', 'get_masks(slen, lengths, causal, padding_mask=None, dtype=tf.float32)', {'shape_list': shape_list, 'tf': tf, 'slen': slen, 'lengths': lengths, 'causal': causal, 'padding_mask': padding_mask, 'dtype': dtype}, 2)
...
class TFXLMMainLayer(tf.keras.layers.Layer):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.position_embeddings = tf.keras.layers.Embedding(config.max_position_embeddings, self.dim, embeddings_initializer=get_initializer(config.embed_init_std), name='position_embeddings')
        if config.sinusoidal_embeddings:
            raise NotImplementedError
        if (config.n_langs > 1 and config.use_lang_emb):
            self.lang_embeddings = tf.keras.layers.Embedding(self.n_langs, self.dim, embeddings_initializer=get_initializer(config.embed_init_std), name='lang_embeddings')
        ...
        for i in range(self.n_layers):
            self.attentions.append(TFXLMMultiHeadAttention(self.n_heads, self.dim, config=config, name='attentions_._{}'.format(i)))
            self.layer_norm1.append(tf.keras.layers.LayerNormalization(epsilon=config.layer_norm_eps, name='layer_norm1_._{}'.format(i)))
            self.ffns.append(TFXLMTransformerFFN(self.dim, self.hidden_dim, self.dim, config=config, name='ffns_._{}'.format(i)))
    ...
    def call(self, inputs, attention_mask=None, langs=None, token_type_ids=None, position_ids=None, lengths=None, cache=None, head_mask=None, inputs_embeds=None, output_attentions=None, output_hidden_states=None, return_dict=None, training=False):
...
class TFXLMForSequenceClassification(TFXLMPreTrainedModel, TFSequenceClassificationLoss):
    ...
    def call(self, inputs=None, attention_mask=None, langs=None, token_type_ids=None, position_ids=None, lengths=None, cache=None, head_mask=None, inputs_embeds=None, output_attentions=None, output_hidden_states=None, return_dict=None, labels=None, training=False):
        """
...
class TFXLMForMultipleChoice(TFXLMPreTrainedModel, TFMultipleChoiceLoss):
    ...
    def dummy_inputs(self):
        ...
        """
        return {'input_ids': tf.constant(MULTIPLE_CHOICE_DUMMY_INPUTS), 'langs': tf.constant(MULTIPLE_CHOICE_DUMMY_INPUTS)}
    ...
    def call(self, inputs, attention_mask=None, langs=None, token_type_ids=None, position_ids=None, lengths=None, cache=None, head_mask=None, inputs_embeds=None, output_attentions=None, output_hidden_states=None, return_dict=None, labels=None, training=False):
        """
        labels (:obj:`tf.Tensor` of shape :obj:`(batch_size,)`, `optional`):
        ...
        if lengths is not None:
            warnings.warn('The `lengths` parameter cannot be used with the XLM multiple choice models. Please use the attention mask instead.', FutureWarning)
            lengths = None
...
class TFXLMForQuestionAnsweringSimple(TFXLMPreTrainedModel, TFQuestionAnsweringLoss):
    ...
    def call(self, inputs=None, attention_mask=None, langs=None, token_type_ids=None, position_ids=None, lengths=None, cache=None, head_mask=None, inputs_embeds=None, output_attentions=None, output_hidden_states=None, return_dict=None, start_positions=None, end_positions=None, training=False):
        """
