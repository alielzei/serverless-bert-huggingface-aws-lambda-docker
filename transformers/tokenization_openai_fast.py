...
PRETRAINED_VOCAB_FILES_MAP = {'vocab_file': {'openai-gpt': 'https://s3.amazonaws.com/models.huggingface.co/bert/openai-gpt-vocab.json'}, 'merges_file': {'openai-gpt': 'https://s3.amazonaws.com/models.huggingface.co/bert/openai-gpt-merges.txt'}, 'tokenizer_file': {'openai-gpt': 'https://s3.amazonaws.com/models.huggingface.co/bert/openai-gpt-tokenizer.json'}}
