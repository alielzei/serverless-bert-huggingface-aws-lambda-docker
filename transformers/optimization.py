...
def get_constant_schedule_with_warmup(optimizer: Optimizer, num_warmup_steps: int, last_epoch: int = -1):
    ...
    return custom_funtemplate.rewrite_template('transformers.optimization.get_constant_schedule_with_warmup', 'get_constant_schedule_with_warmup(optimizer, num_warmup_steps, last_epoch=-1)', {'LambdaLR': LambdaLR, 'optimizer': optimizer, 'num_warmup_steps': num_warmup_steps, 'last_epoch': last_epoch}, 1)
...
def get_linear_schedule_with_warmup(optimizer, num_warmup_steps, num_training_steps, last_epoch=-1):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('transformers.optimization.get_linear_schedule_with_warmup', 'get_linear_schedule_with_warmup(optimizer, num_warmup_steps, num_training_steps, last_epoch=-1)', {'LambdaLR': LambdaLR, 'optimizer': optimizer, 'num_warmup_steps': num_warmup_steps, 'num_training_steps': num_training_steps, 'last_epoch': last_epoch}, 1)
...
def get_cosine_schedule_with_warmup(optimizer: Optimizer, num_warmup_steps: int, num_training_steps: int, num_cycles: float = 0.5, last_epoch: int = -1):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('transformers.optimization.get_cosine_schedule_with_warmup', 'get_cosine_schedule_with_warmup(optimizer, num_warmup_steps, num_training_steps, num_cycles=0.5, last_epoch=-1)', {'math': math, 'LambdaLR': LambdaLR, 'optimizer': optimizer, 'num_warmup_steps': num_warmup_steps, 'num_training_steps': num_training_steps, 'num_cycles': num_cycles, 'last_epoch': last_epoch}, 1)
...
def get_cosine_with_hard_restarts_schedule_with_warmup(optimizer: Optimizer, num_warmup_steps: int, num_training_steps: int, num_cycles: int = 1, last_epoch: int = -1):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('transformers.optimization.get_cosine_with_hard_restarts_schedule_with_warmup', 'get_cosine_with_hard_restarts_schedule_with_warmup(optimizer, num_warmup_steps, num_training_steps, num_cycles=1, last_epoch=-1)', {'math': math, 'LambdaLR': LambdaLR, 'optimizer': optimizer, 'num_warmup_steps': num_warmup_steps, 'num_training_steps': num_training_steps, 'num_cycles': num_cycles, 'last_epoch': last_epoch}, 1)
...
def get_polynomial_decay_schedule_with_warmup(optimizer, num_warmup_steps, num_training_steps, lr_end=1e-07, power=1.0, last_epoch=-1):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('transformers.optimization.get_polynomial_decay_schedule_with_warmup', 'get_polynomial_decay_schedule_with_warmup(optimizer, num_warmup_steps, num_training_steps, lr_end=1e-07, power=1.0, last_epoch=-1)', {'LambdaLR': LambdaLR, 'optimizer': optimizer, 'num_warmup_steps': num_warmup_steps, 'num_training_steps': num_training_steps, 'lr_end': lr_end, 'power': power, 'last_epoch': last_epoch}, 1)
