...
from .modeling_outputs import BaseModelOutput, BaseModelOutputWithPast, Seq2SeqLMOutput, Seq2SeqModelOutput, Seq2SeqQuestionAnsweringModelOutput, Seq2SeqSequenceClassifierOutput
...
def _prepare_bart_decoder_inputs(config, input_ids, decoder_input_ids=None, decoder_padding_mask=None, causal_mask_dtype=torch.float32):
    ...
    return custom_funtemplate.rewrite_template('transformers.modeling_bart._prepare_bart_decoder_inputs', '_prepare_bart_decoder_inputs(config, input_ids, decoder_input_ids=None, decoder_padding_mask=None, causal_mask_dtype=torch.float32)', {'shift_tokens_right': shift_tokens_right, 'make_padding_mask': make_padding_mask, 'invert_mask': invert_mask, 'fill_with_neg_inf': fill_with_neg_inf, 'torch': torch, 'config': config, 'input_ids': input_ids, 'decoder_input_ids': decoder_input_ids, 'decoder_padding_mask': decoder_padding_mask, 'causal_mask_dtype': causal_mask_dtype}, 3)
...
def _make_linear_from_emb(emb):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('transformers.modeling_bart._make_linear_from_emb', '_make_linear_from_emb(emb)', {'nn': nn, 'emb': emb}, 1)
...
def shift_tokens_right(input_ids, pad_token_id):
    ...
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('transformers.modeling_bart.shift_tokens_right', 'shift_tokens_right(input_ids, pad_token_id)', {'input_ids': input_ids, 'pad_token_id': pad_token_id}, 1)

def make_padding_mask(input_ids, padding_idx=1):
    """True for pad tokens"""
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('transformers.modeling_bart.make_padding_mask', 'make_padding_mask(input_ids, padding_idx=1)', {'input_ids': input_ids, 'padding_idx': padding_idx}, 1)
...
class BartDecoder(nn.Module):
    ...
    def forward(self, input_ids, encoder_hidden_states, encoder_padding_mask, decoder_padding_mask, decoder_causal_mask, past_key_values=None, use_cache=False, output_attentions=False, output_hidden_states=False, return_dict=False, **unused):
        """
        ...
        return BaseModelOutputWithPast(last_hidden_state=x, past_key_values=next_cache, hidden_states=all_hidden_states, attentions=all_self_attns)


def _reorder_buffer(attn_cache, new_order):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('transformers.modeling_bart._reorder_buffer', '_reorder_buffer(attn_cache, new_order)', {'attn_cache': attn_cache, 'new_order': new_order}, 1)
...
def LayerNorm(normalized_shape, eps=1e-05, elementwise_affine=True):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('transformers.modeling_bart.LayerNorm', 'LayerNorm(normalized_shape, eps=1e-05, elementwise_affine=True)', {'torch': torch, 'normalized_shape': normalized_shape, 'eps': eps, 'elementwise_affine': elementwise_affine}, 1)
...
class BartModel(PretrainedBartModel):
    ...
    def forward(self, input_ids, attention_mask=None, decoder_input_ids=None, decoder_attention_mask=None, encoder_outputs: Optional[Tuple] = None, past_key_values=None, use_cache=None, output_attentions=None, output_hidden_states=None, return_dict=None, **kwargs):
        ...
        if encoder_outputs is None:
            encoder_outputs = self.encoder(input_ids=input_ids, attention_mask=attention_mask, output_attentions=output_attentions, output_hidden_states=output_hidden_states, return_dict=return_dict)
        elif (return_dict and not isinstance(encoder_outputs, BaseModelOutput)):
            encoder_outputs = BaseModelOutput(last_hidden_state=encoder_outputs[0], hidden_states=(encoder_outputs[1] if len(encoder_outputs) > 1 else None), attentions=(encoder_outputs[2] if len(encoder_outputs) > 2 else None))
        decoder_outputs = self.decoder(decoder_input_ids, encoder_outputs[0], attention_mask, decoder_padding_mask, decoder_causal_mask=causal_mask, past_key_values=past_key_values, use_cache=use_cache, output_attentions=output_attentions, output_hidden_states=output_hidden_states, return_dict=return_dict)
        if not return_dict:
...
class BartForConditionalGeneration(PretrainedBartModel):
    ...
    def forward(self, input_ids, attention_mask=None, decoder_input_ids=None, decoder_attention_mask=None, encoder_outputs=None, past_key_values=None, labels=None, use_cache=None, output_attentions=None, output_hidden_states=None, return_dict=None, **unused):
        """
...
class BartForSequenceClassification(PretrainedBartModel):
    ...
    def forward(self, input_ids, attention_mask=None, decoder_input_ids=None, decoder_attention_mask=None, encoder_outputs=None, labels=None, use_cache=None, output_attentions=None, output_hidden_states=None, return_dict=None):
        """
        ...
        if labels is not None:
            use_cache = False
        outputs = self.model(input_ids, attention_mask=attention_mask, decoder_input_ids=decoder_input_ids, decoder_attention_mask=decoder_attention_mask, encoder_outputs=encoder_outputs, use_cache=use_cache, output_attentions=output_attentions, output_hidden_states=output_hidden_states, return_dict=return_dict)
        x = outputs[0]
...
class BartForQuestionAnswering(PretrainedBartModel):
    ...
    def forward(self, input_ids, attention_mask=None, decoder_input_ids=None, decoder_attention_mask=None, encoder_outputs=None, start_positions=None, end_positions=None, use_cache=None, output_attentions=None, output_hidden_states=None, return_dict=None):
        """
