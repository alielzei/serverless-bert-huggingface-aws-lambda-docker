...
def get_pairs(word):
    ...
    return custom_funtemplate.rewrite_template('transformers.tokenization_openai.get_pairs', 'get_pairs(word)', {'word': word}, 1)
...
def text_standardize(text):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('transformers.tokenization_openai.text_standardize', 'text_standardize(text)', {'re': re, 'text': text}, 1)
