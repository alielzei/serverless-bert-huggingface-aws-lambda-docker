...
def create_optimizer(init_lr: float, num_train_steps: int, num_warmup_steps: int, min_lr_ratio: float = 0.0, adam_beta1: float = 0.9, adam_beta2: float = 0.999, adam_epsilon: float = 1e-08, weight_decay_rate: float = 0.0, power: float = 1.0, include_in_weight_decay: Optional[List[str]] = None):
    ...
    return custom_funtemplate.rewrite_template('transformers.optimization_tf.create_optimizer', 'create_optimizer(init_lr, num_train_steps, num_warmup_steps, min_lr_ratio=0.0, adam_beta1=0.9, adam_beta2=0.999, adam_epsilon=1e-08, weight_decay_rate=0.0, power=1.0, include_in_weight_decay=None)', {'tf': tf, 'WarmUp': WarmUp, 'AdamWeightDecay': AdamWeightDecay, 'init_lr': init_lr, 'num_train_steps': num_train_steps, 'num_warmup_steps': num_warmup_steps, 'min_lr_ratio': min_lr_ratio, 'adam_beta1': adam_beta1, 'adam_beta2': adam_beta2, 'adam_epsilon': adam_epsilon, 'weight_decay_rate': weight_decay_rate, 'power': power, 'include_in_weight_decay': include_in_weight_decay, 'Optional': Optional}, 2)
