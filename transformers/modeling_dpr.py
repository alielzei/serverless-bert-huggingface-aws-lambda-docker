...
class DPRContextEncoder(DPRPretrainedContextEncoder):
    ...
    def forward(self, input_ids: Optional[Tensor] = None, attention_mask: Optional[Tensor] = None, token_type_ids: Optional[Tensor] = None, inputs_embeds: Optional[Tensor] = None, output_attentions=None, output_hidden_states=None, return_dict=None) -> Union[(DPRContextEncoderOutput, Tuple[(Tensor, ...)])]:
        """
        Return:
...
class DPRQuestionEncoder(DPRPretrainedQuestionEncoder):
    ...
    def forward(self, input_ids: Optional[Tensor] = None, attention_mask: Optional[Tensor] = None, token_type_ids: Optional[Tensor] = None, inputs_embeds: Optional[Tensor] = None, output_attentions=None, output_hidden_states=None, return_dict=None) -> Union[(DPRQuestionEncoderOutput, Tuple[(Tensor, ...)])]:
        """
        Return:
...
class DPRReader(DPRPretrainedReader):
    ...
    def forward(self, input_ids: Optional[Tensor] = None, attention_mask: Optional[Tensor] = None, inputs_embeds: Optional[Tensor] = None, output_attentions: bool = None, output_hidden_states: bool = None, return_dict=None) -> Union[(DPRReaderOutput, Tuple[(Tensor, ...)])]:
        """
        Return:
