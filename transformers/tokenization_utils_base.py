...
import numpy as np
from .file_utils import add_end_docstrings, cached_path, hf_bucket_url, is_flax_available, is_remote_url, is_tf_available, is_tokenizers_available, is_torch_available, torch_required
...
class BatchEncoding(UserDict):
    ...
    def __init__(self, data: Optional[Dict[(str, Any)]] = None, encoding: Optional[Union[(EncodingFast, Sequence[EncodingFast])]] = None, tensor_type: Union[(None, str, TensorType)] = None, prepend_batch_axis: bool = False):
        super().__init__(data)
