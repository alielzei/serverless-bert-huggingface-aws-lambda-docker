...
def load_tf_weights_in_albert(model, config, tf_checkpoint_path):
    ...
    return custom_funtemplate.rewrite_template('transformers.modeling_albert.load_tf_weights_in_albert', 'load_tf_weights_in_albert(model, config, tf_checkpoint_path)', {'logger': logger, 'os': os, 'torch': torch, 'model': model, 'config': config, 'tf_checkpoint_path': tf_checkpoint_path}, 1)
...
class AlbertTransformer(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask=None, head_mask=None, output_attentions=False, output_hidden_states=False, return_dict=False):
...
class AlbertForPreTraining(AlbertPreTrainedModel):
    ...
    def forward(self, input_ids=None, attention_mask=None, token_type_ids=None, position_ids=None, head_mask=None, inputs_embeds=None, labels=None, sentence_order_label=None, output_attentions=None, output_hidden_states=None, return_dict=None, **kwargs):
        """
