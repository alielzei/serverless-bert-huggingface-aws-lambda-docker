...
def load_tf_weights_in_mobilebert(model, config, tf_checkpoint_path):
    ...
    return custom_funtemplate.rewrite_template('transformers.modeling_mobilebert.load_tf_weights_in_mobilebert', 'load_tf_weights_in_mobilebert(model, config, tf_checkpoint_path)', {'logger': logger, 'os': os, 'torch': torch, 'model': model, 'config': config, 'tf_checkpoint_path': tf_checkpoint_path}, 1)
...
class MobileBertModel(MobileBertPreTrainedModel):
    ...
    def forward(self, input_ids=None, attention_mask=None, token_type_ids=None, position_ids=None, head_mask=None, inputs_embeds=None, encoder_hidden_states=None, encoder_attention_mask=None, output_hidden_states=None, output_attentions=None, return_dict=None):
...
class MobileBertForPreTraining(MobileBertPreTrainedModel):
    ...
    def tie_weights(self):
        ...
        resized_dense = nn.Linear(input_embeddings.num_embeddings, self.config.hidden_size - self.config.embedding_size, bias=False)
        kept_data = self.cls.predictions.dense.weight.data[..., :min(self.cls.predictions.dense.weight.data.shape[1], resized_dense.weight.data.shape[1])]
...
class MobileBertForMaskedLM(MobileBertPreTrainedModel):
    ...
    def forward(self, input_ids=None, attention_mask=None, token_type_ids=None, position_ids=None, head_mask=None, inputs_embeds=None, labels=None, encoder_hidden_states=None, encoder_attention_mask=None, output_attentions=None, output_hidden_states=None, return_dict=None, **kwargs):
        """
