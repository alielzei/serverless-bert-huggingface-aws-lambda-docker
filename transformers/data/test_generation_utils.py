...
class GenerationUtilsTest(unittest.TestCase):
    ...
    def test_postprocess_next_token_scores(self):
        ...
        masked_scores = [[(0, 299), (1, 299), (2, 299), (3, 299), (4, 299), (5, 299), (6, 299), (7, 299)], [(1, 24), (0, 54), (1, 54), (2, 54), (3, 54), (4, 54), (5, 54), (6, 54), (7, 54)], [(0, eos), (1, eos), (2, eos), (3, eos), (4, eos), (5, eos), (6, eos), (7, eos)], []]
        for (test_case_index, bad_words_ids) in enumerate(bad_words_ids_test_cases):
            scores = torch.rand((8, 300))
            output = model.postprocess_next_token_scores(scores, input_ids, 0, bad_words_ids, 13, 15, config.max_length, config.eos_token_id, config.repetition_penalty, 32, 5)
    ...
    def test_postprocess_next_token_scores_large_bad_words_list(self):
        ...
        scores = torch.rand((8, 300))
        _ = model.postprocess_next_token_scores(scores, input_ids, 0, bad_words_ids, 13, 15, config.max_length, config.eos_token_id, config.repetition_penalty, 32, 5)
