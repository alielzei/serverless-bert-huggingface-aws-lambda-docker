...
def positional_encoding(position, d_model_size, dtype):
    ...
    return custom_funtemplate.rewrite_template('transformers.modeling_ctrl.positional_encoding', 'positional_encoding(position, d_model_size, dtype)', {'angle_defn': angle_defn, 'torch': torch, 'position': position, 'd_model_size': d_model_size, 'dtype': dtype}, 1)

def scaled_dot_product_attention(q, k, v, mask, attention_mask=None, head_mask=None):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('transformers.modeling_ctrl.scaled_dot_product_attention', 'scaled_dot_product_attention(q, k, v, mask, attention_mask=None, head_mask=None)', {'torch': torch, 'np': np, 'q': q, 'k': k, 'v': v, 'mask': mask, 'attention_mask': attention_mask, 'head_mask': head_mask}, 2)
...
class CTRLModel(CTRLPreTrainedModel):
    ...
    def forward(self, input_ids=None, past_key_values=None, attention_mask=None, token_type_ids=None, position_ids=None, head_mask=None, inputs_embeds=None, use_cache=None, output_attentions=None, output_hidden_states=None, return_dict=None, **kwargs):
        if 'past' in kwargs:
...
class CTRLLMHeadModel(CTRLPreTrainedModel):
    ...
    def forward(self, input_ids=None, past_key_values=None, attention_mask=None, token_type_ids=None, position_ids=None, head_mask=None, inputs_embeds=None, labels=None, use_cache=None, output_attentions=None, output_hidden_states=None, return_dict=None, **kwargs):
        """
