...
def convert_tf_checkpoint_to_pytorch(tf_checkpoint_path, config_file, pytorch_dump_path):
    ...
    custom_funtemplate.rewrite_template('transformers.convert_lxmert_original_tf_checkpoint_to_pytorch.convert_tf_checkpoint_to_pytorch', 'convert_tf_checkpoint_to_pytorch(tf_checkpoint_path, config_file, pytorch_dump_path)', {'LxmertConfig': LxmertConfig, 'LxmertForPreTraining': LxmertForPreTraining, 'load_tf_weights_in_lxmert': load_tf_weights_in_lxmert, 'torch': torch, 'tf_checkpoint_path': tf_checkpoint_path, 'config_file': config_file, 'pytorch_dump_path': pytorch_dump_path}, 0)
