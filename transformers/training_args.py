...
def default_logdir() -> str:
    ...
    return custom_funtemplate.rewrite_template('transformers.training_args.default_logdir', 'default_logdir()', {'os': os}, 1)
...
class TrainingArguments:
    ...
    **which relate to the training loop itself**.
    ...
    evaluation_strategy: EvaluationStrategy = field(default='no', metadata={'help': 'Run evaluation during training at each logging step.'})
    ...
    learning_rate: float = field(default=5e-05, metadata={'help': 'The initial learning rate for Adam.'})
    weight_decay: float = field(default=0.0, metadata={'help': 'Weight decay if we apply some.'})
    adam_beta1: float = field(default=0.9, metadata={'help': 'Beta1 for Adam optimizer'})
    adam_beta2: float = field(default=0.999, metadata={'help': 'Beta2 for Adam optimizer'})
    adam_epsilon: float = field(default=1e-08, metadata={'help': 'Epsilon for Adam optimizer.'})
    ...
    run_name: Optional[str] = field(default=None, metadata={'help': 'An optional descriptor for the run. Notably used for wandb logging.'})
    ...
    def __post_init__(self):
        ...
        if self.evaluate_during_training is True:
            ...
            warnings.warn('The `evaluate_during_training` argument is deprecated in favor of `evaluation_strategy` (which has more options)', FutureWarning)
