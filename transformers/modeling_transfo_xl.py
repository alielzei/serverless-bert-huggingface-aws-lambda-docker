...
def build_tf_to_pytorch_map(model, config):
    ...
    return custom_funtemplate.rewrite_template('transformers.modeling_transfo_xl.build_tf_to_pytorch_map', 'build_tf_to_pytorch_map(model, config)', {'model': model, 'config': config}, 1)

def load_tf_weights_in_transfo_xl(model, config, tf_path):
    """Load tf checkpoints in a pytorch model"""
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('transformers.modeling_transfo_xl.load_tf_weights_in_transfo_xl', 'load_tf_weights_in_transfo_xl(model, config, tf_path)', {'logger': logger, 'build_tf_to_pytorch_map': build_tf_to_pytorch_map, 'torch': torch, 'model': model, 'config': config, 'tf_path': tf_path}, 1)
...
class TransfoXLModel(TransfoXLPreTrainedModel):
    ...
    def forward(self, input_ids=None, mems=None, head_mask=None, inputs_embeds=None, output_attentions=None, output_hidden_states=None, return_dict=None):
...
class TransfoXLLMHeadModel(TransfoXLPreTrainedModel):
    ...
    def forward(self, input_ids=None, mems=None, head_mask=None, inputs_embeds=None, labels=None, output_attentions=None, output_hidden_states=None, return_dict=None):
        """
        ...
        return TransfoXLLMHeadModelOutput(losses=loss, prediction_scores=prediction_scores, mems=transformer_outputs.mems, hidden_states=transformer_outputs.hidden_states, attentions=transformer_outputs.attentions)
