...
class TestCase(hu.HypothesisTestCase):
    ...
    @given(comm_size=st.integers(min_value=2, max_value=8), blob_size=st.integers(min_value=1000.0, max_value=1000000.0), num_blobs=st.integers(min_value=1, max_value=4), device_option=st.sampled_from([hu.cpu_do]), use_float16=st.booleans())
