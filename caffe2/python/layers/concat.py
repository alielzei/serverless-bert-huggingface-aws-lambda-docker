...
def get_concatenated_feature_to_index(blobs_to_concat):
    ...
    return custom_funtemplate.rewrite_template('caffe2.python.layers.concat.get_concatenated_feature_to_index', 'get_concatenated_feature_to_index(blobs_to_concat)', {'defaultdict': defaultdict, 'blobs_to_concat': blobs_to_concat}, 1)
