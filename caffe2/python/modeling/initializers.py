...
def update_initializer(initializer_class, operator_name_and_kwargs, default_operator_name_and_kwargs):
    ...
    return custom_funtemplate.rewrite_template('caffe2.python.modeling.initializers.update_initializer', 'update_initializer(initializer_class, operator_name_and_kwargs, default_operator_name_and_kwargs)', {'Initializer': Initializer, 'initializer_class': initializer_class, 'operator_name_and_kwargs': operator_name_and_kwargs, 'default_operator_name_and_kwargs': default_operator_name_and_kwargs}, 1)
