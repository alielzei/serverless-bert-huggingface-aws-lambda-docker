...
def dummy_fetcher(fetcher_id, batch_size):
    ...
    return custom_funtemplate.rewrite_template('caffe2.python.data_workers_test.dummy_fetcher', 'dummy_fetcher(fetcher_id, batch_size)', {'np': np, 'fetcher_id': fetcher_id, 'batch_size': batch_size}, 1)

def dummy_fetcher_rnn(fetcher_id, batch_size):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('caffe2.python.data_workers_test.dummy_fetcher_rnn', 'dummy_fetcher_rnn(fetcher_id, batch_size)', {'np': np, 'fetcher_id': fetcher_id, 'batch_size': batch_size}, 1)
