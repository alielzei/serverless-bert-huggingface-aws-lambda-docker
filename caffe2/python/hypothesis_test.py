...
@st.composite
def _tensor_and_prefix(dtype, elements, min_dim=1, max_dim=4, **kwargs):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('caffe2.python.hypothesis_test._tensor_and_prefix', '_tensor_and_prefix(dtype, elements, min_dim=1, max_dim=4, **kwargs)', {'draw': draw, 'hu': hu, 'assume': assume, 'st': st, 'dtype': dtype, 'elements': elements, 'min_dim': min_dim, 'max_dim': max_dim, 'kwargs': kwargs}, 2)
...
def _tensor_and_indices(min_dim=1, max_dim=4, dtype=np.float32, elements=None, **kwargs):
    ...
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('caffe2.python.hypothesis_test._tensor_and_indices', '_tensor_and_indices(min_dim=1, max_dim=4, dtype=np.float32, elements=None, **kwargs)', {'st': st, 'hu': hu, 'np': np, 'min_dim': min_dim, 'max_dim': max_dim, 'dtype': dtype, 'elements': elements, 'kwargs': kwargs}, 1)
_NUMPY_TYPE_TO_ENUM = {np.float32: core.DataType.FLOAT, np.int32: core.DataType.INT32, np.bool: core.DataType.BOOL, np.uint8: core.DataType.UINT8, np.int8: core.DataType.INT8, np.uint16: core.DataType.UINT16, np.int16: core.DataType.INT16, np.int64: core.DataType.INT64, np.float64: core.DataType.DOUBLE}
...
def _test_binary(name, ref, filter_=None, gcs=hu.gcs, test_gradient=False, allow_inplace=False, dtypes=_dtypes):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('caffe2.python.hypothesis_test._test_binary', '_test_binary(name, ref, filter_=None, gcs=hu.gcs, test_gradient=False, allow_inplace=False, dtypes=_dtypes)', {'given': given, 'hu': hu, 'st': st, 'settings': settings, 'core': core, 'np': np, 'name': name, 'ref': ref, 'filter_': filter_, 'gcs': gcs, 'test_gradient': test_gradient, 'allow_inplace': allow_inplace, 'dtypes': dtypes, '_dtypes': _dtypes}, 1)

def _test_binary_broadcast(name, ref, filter_=None, gcs=hu.gcs, allow_inplace=False, dtypes=_dtypes):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('caffe2.python.hypothesis_test._test_binary_broadcast', '_test_binary_broadcast(name, ref, filter_=None, gcs=hu.gcs, allow_inplace=False, dtypes=_dtypes)', {'given': given, '_tensor_and_prefix': _tensor_and_prefix, 'hu': hu, 'st': st, 'settings': settings, 'core': core, 'np': np, 'name': name, 'ref': ref, 'filter_': filter_, 'gcs': gcs, 'allow_inplace': allow_inplace, 'dtypes': dtypes, '_dtypes': _dtypes}, 1)
...
class TestOperators(hu.HypothesisTestCase):
    ...
    @given(hidden_size=st.integers(min_value=1, max_value=3), num_layers=st.integers(min_value=1, max_value=3), bidirectional=st.booleans(), rnn_mode=st.sampled_from(['lstm']), input_mode=st.sampled_from(['linear']), dropout=st.floats(min_value=1.0, max_value=1.0), T=st.integers(min_value=2, max_value=6), N=st.integers(min_value=1, max_value=4), D=st.integers(min_value=1, max_value=4))
    ...
    @given(X=hu.arrays(dims=[5, 2], elements=st.floats(min_value=1.0, max_value=10.0)), **hu.gcs_cpu_only)
    ...
    @given(inputs=hu.tensors(n=2), in_place=st.booleans(), momentum=st.floats(min_value=0.1, max_value=0.9), nesterov=st.booleans(), lr=st.floats(min_value=0.1, max_value=0.9), **hu.gcs)
    ...
    @given(inputs=hu.tensors(n=3), in_place=st.booleans(), decay=st.floats(min_value=0.1, max_value=0.9), momentum=st.floats(min_value=0.1, max_value=0.9), lr=st.floats(min_value=0.1, max_value=0.9), epsilon=st.floats(min_value=1e-05, max_value=0.01), **hu.gcs)
    ...
    @given(inputs=hu.tensors(n=4), in_place=st.booleans(), alpha=st.floats(min_value=0.01, max_value=0.1), beta=st.floats(min_value=0.1, max_value=0.9), lambda1=st.floats(min_value=0.001, max_value=0.1), lambda2=st.floats(min_value=0.001, max_value=0.1), engine=st.sampled_from([None, 'SIMD']), **hu.gcs_cpu_only)
    ...
    @given(inputs=hu.tensors(n=4), alpha=st.floats(min_value=0.01, max_value=0.1), beta=st.floats(min_value=0.1, max_value=0.9), lambda1=st.floats(min_value=0.001, max_value=0.1), lambda2=st.floats(min_value=0.001, max_value=0.1), engine=st.sampled_from([None, 'SIMD']), **hu.gcs_cpu_only)
    ...
    @given(input=hu.tensor(max_value=20, max_dim=1, dtype=np.int32, elements=st.integers(min_value=0, max_value=10)), with_remapping=st.booleans(), **hu.gcs)
    ...
    @given(prediction=hu.arrays(dims=[10, 3], elements=st.floats(allow_nan=False, allow_infinity=False, min_value=0, max_value=1)), labels=hu.arrays(dims=[10], dtype=np.int32, elements=st.integers(min_value=0, max_value=3 - 1)), top_k=st.integers(min_value=1, max_value=3), **hu.gcs)
    ...
    @given(target_probabilities=hu.arrays(dims=[10], elements=st.floats(allow_nan=False, allow_infinity=False, min_value=0.01, max_value=1)), **hu.gcs)
    ...
    @given(prediction=hu.arrays(dims=[10, 3], elements=st.floats(allow_nan=False, allow_infinity=False, min_value=0, max_value=1)), labels=hu.arrays(dims=[10], dtype=np.int32, elements=st.integers(min_value=0, max_value=3 - 1)), **hu.gcs)
    ...
    @given(input_tensor=hu.arrays(dims=[10], elements=st.floats(allow_nan=False, allow_infinity=False)), **hu.gcs)
    ...
    @given(input_tensor=hu.arrays(dims=[10], elements=st.floats(min_value=-10, max_value=10)), **hu.gcs)
    ...
    @given(input_tensor=hu.arrays(dims=[10], elements=st.floats(min_value=1, max_value=10000)), **hu.gcs_cpu_only)
    ...
    @given(a=hu.tensor(), src=st.sampled_from(list(viewkeys(_NUMPY_TYPE_TO_ENUM))), dst=st.sampled_from(list(viewkeys(_NUMPY_TYPE_TO_ENUM))), use_name=st.booleans(), **hu.gcs)
    ...
    @given(a=hu.tensor(), eps=st.floats(min_value=0.0001, max_value=0.01), a_grad=hu.tensor(elements=st.floats(min_value=0.01, max_value=0.99)), eps_grad=st.floats(min_value=0.0001, max_value=0.001), **hu.gcs)
    ...
    @given(a=hu.tensor(elements=st.floats(allow_nan=True)), value=st.floats(min_value=-10, max_value=10), **hu.gcs)
    ...
    @given(data=_dtypes(dtypes=[np.int32, np.int64, np.float32, np.bool]).flatmap(lambda dtype: hu.tensor(min_dim=1, dtype=dtype, elements=hu.elements_of_type(dtype))), has_input=st.booleans(), has_extra_shape=st.booleans(), extra_shape=st.lists(min_size=1, max_size=5, elements=st.integers(1, 5)), **hu.gcs)
    ...
    @given(X=hu.tensor(), in_place=st.booleans(), scale=st.floats(min_value=-2.0, max_value=2.0), **hu.gcs)
    ...
    @given(size=st.integers(7, 10), input_channels=st.integers(1, 10), batch_size=st.integers(1, 3), order=st.sampled_from(['NCHW', 'NHWC']), epsilon=st.floats(min_value=0.0001, max_value=0.01), **hu.gcs_cpu_only)
    ...
    @given(inp=_dtypes().flatmap(lambda dt: _tensor_and_indices(elements=st.floats(min_value=0, max_value=1), dtype=dt)), **hu.gcs)
    ...
    @given(N=st.integers(min_value=2, max_value=10), M=st.integers(min_value=2, max_value=10), K=st.integers(min_value=2, max_value=10), pad_value=st.floats(min_value=0.1, max_value=1.0), **hu.gcs_cpu_only)
    ...
    @given(N=st.integers(min_value=2, max_value=10), M=st.integers(min_value=2, max_value=10), pad_value=st.floats(min_value=0.1, max_value=1.0), **hu.gcs_cpu_only)
