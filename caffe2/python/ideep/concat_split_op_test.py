...
def _tensor_splits(add_axis=False):
    ...
    return custom_funtemplate.rewrite_template('caffe2.python.ideep.concat_split_op_test._tensor_splits', '_tensor_splits(add_axis=False)', {'draw': draw, 'hu': hu, 'np': np, 'st': st, 'add_axis': add_axis}, 3)
