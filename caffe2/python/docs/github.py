...
def getCodeLink(formatter, schema):
    ...
    return custom_funtemplate.rewrite_template('caffe2.python.docs.github.getCodeLink', 'getCodeLink(formatter, schema)', {'os': os, 'formatter': formatter, 'schema': schema}, 1)
