...
def create_shufflenet(model, data, num_input_channels, num_labels, label=None, is_test=False, no_loss=False):
    ...
    return custom_funtemplate.rewrite_template('caffe2.python.models.shufflenet.create_shufflenet', 'create_shufflenet(model, data, num_input_channels, num_labels, label=None, is_test=False, no_loss=False)', {'ShuffleNetV2Builder': ShuffleNetV2Builder, 'model': model, 'data': data, 'num_input_channels': num_input_channels, 'num_labels': num_labels, 'label': label, 'is_test': is_test, 'no_loss': no_loss}, 1)
