...
def CompleteInTimeOrDie(timeout_secs):
    ...
    custom_funtemplate.rewrite_template('caffe2.python.timeout_guard.CompleteInTimeOrDie', 'CompleteInTimeOrDie(timeout_secs)', {'WatcherThread': WatcherThread, 'contextlib': contextlib, 'timeout_secs': timeout_secs}, 0)
