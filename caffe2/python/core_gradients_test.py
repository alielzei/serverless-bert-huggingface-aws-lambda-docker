...
def NeedAll(op, g_output):
    ...
    return custom_funtemplate.rewrite_template('caffe2.python.core_gradients_test.NeedAll', 'NeedAll(op, g_output)', {'op': op, 'g_output': g_output}, 1)
...
def CopyDeviceOption(op, src_op):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('caffe2.python.core_gradients_test.CopyDeviceOption', 'CopyDeviceOption(op, src_op)', {'op': op, 'src_op': src_op}, 1)
