...
from caffe2.python.schema import Struct, FetchRecord, NewRecord, FeedRecord, InitEmptyRecord
...
class TestPipeline(TestCase):
    ...
    def test_dequeue_many(self):
        ...
        self.assertEquals(num_dequeues, int(math.ceil(float(N) / NUM_DEQUEUE_RECORDS)))
