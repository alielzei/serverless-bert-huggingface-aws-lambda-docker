...
class TestPutOps(TestCase):
    ...
    def test_default_value(self):
        ...
        self.assertEquals(stat_dict[stat_name + sum_postfix], default_value * magnitude_expand)
    ...
    def test_increment_put_ops(self):
        ...
        self.assertEquals(stat_dict[stat_name + member_postfix], put_value * magnitude_expand)
