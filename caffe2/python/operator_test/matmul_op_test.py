...
class TestBatchMatMul(serial.SerializedTestCase):
    ...
    @serial.given(C_1=st.integers(min_value=0, max_value=3), C_2=st.integers(min_value=0, max_value=3), M=st.integers(min_value=1, max_value=10), K=st.integers(min_value=1, max_value=10), N=st.integers(min_value=1, max_value=10), trans_a=st.booleans(), trans_b=st.booleans(), **hu.gcs)
