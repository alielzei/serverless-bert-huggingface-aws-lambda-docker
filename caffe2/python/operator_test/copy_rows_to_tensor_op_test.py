...
def get_input_tensors():
    ...
    return custom_funtemplate.rewrite_template('caffe2.python.operator_test.copy_rows_to_tensor_op_test.get_input_tensors', 'get_input_tensors()', {'np': np, 'hu': hu, 'st': st}, 1)
