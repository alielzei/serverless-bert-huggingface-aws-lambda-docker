...
def _fill_diagonal(shape, value):
    ...
    return custom_funtemplate.rewrite_template('caffe2.python.operator_test.filler_ops_test._fill_diagonal', '_fill_diagonal(shape, value)', {'np': np, 'shape': shape, 'value': value}, 1)
