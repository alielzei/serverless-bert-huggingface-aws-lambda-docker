...
def _cudnn_supports(dilation=False, nhwc=False, backward=False):
    ...
    return custom_funtemplate.rewrite_template('caffe2.python.operator_test.conv_test._cudnn_supports', '_cudnn_supports(dilation=False, nhwc=False, backward=False)', {'workspace': workspace, 'dilation': dilation, 'nhwc': nhwc, 'backward': backward}, 1)

def _cudnn_convolution_algo_count(direction):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('caffe2.python.operator_test.conv_test._cudnn_convolution_algo_count', '_cudnn_convolution_algo_count(direction)', {'st': st, 'C': C, 'direction': direction}, 1)
