...
class TestFeatureMapsOps(TestCase):
    ...
    def test_merge_single_scalar_feature_tensors(self):
        ...
        workspace.FeedBlob('in1', np.array([11.1, 0.0], dtype=np.float))
        workspace.FeedBlob('in1_presence', np.array([True, False], dtype=np.bool))
        workspace.FeedBlob('in2', np.array([12.1, 12.2], dtype=np.float))
        workspace.FeedBlob('in2_presence', np.array([True, True], dtype=np.bool))
        ...
        np.testing.assert_array_equal(workspace.FetchBlob('out_values'), np.array([11.1, 12.1, 12.2], dtype=np.float))
    ...
    def test_merge_single_scalar_feature_tensors_gradient(self):
        ...
        workspace.FeedBlob('in1_presence', np.array([True, False], dtype=np.bool))
        workspace.FeedBlob('in2_presence', np.array([True, True], dtype=np.bool))
        workspace.FeedBlob('in3_presence', np.array([False, True], dtype=np.bool))
        workspace.FeedBlob('out_values_grad', np.array([0.1, 1.1, 1.2, 2.3], dtype=np.float))
        workspace.RunOperatorOnce(op)
        np.testing.assert_array_equal(workspace.FetchBlob('in1_grad'), np.array([0.1, 0], dtype=np.float))
        np.testing.assert_array_equal(workspace.FetchBlob('in2_grad'), np.array([1.1, 1.2], dtype=np.float))
        np.testing.assert_array_equal(workspace.FetchBlob('in3_grad'), np.array([0, 2.3], dtype=np.float))
    ...
    def test_merge_single_list_feature_tensors(self):
        ...
        workspace.FeedBlob('in1_values', np.array([11.1, 11.2], dtype=np.float))
        workspace.FeedBlob('in1_presence', np.array([True, False], dtype=np.bool))
        workspace.FeedBlob('in2_lengths', np.array([2, 2], dtype=np.int32))
        workspace.FeedBlob('in2_values', np.array([12.1, 12.2, 12.3, 12.4], dtype=np.float))
        workspace.FeedBlob('in2_presence', np.array([True, True], dtype=np.bool))
        workspace.RunOperatorOnce(op)
        np.testing.assert_array_equal(workspace.FetchBlob('out_lengths'), np.array([2, 1], dtype=np.int32))
        np.testing.assert_array_equal(workspace.FetchBlob('out_keys'), np.array([11, 12, 12], dtype=np.int64))
        np.testing.assert_array_equal(workspace.FetchBlob('out_values_lengths'), np.array([2, 2, 2], dtype=np.int32))
        np.testing.assert_array_equal(workspace.FetchBlob('out_values_values'), np.array([11.1, 11.2, 12.1, 12.2, 12.3, 12.4], dtype=np.float))
    ...
    def _test_merge_single_list_or_map_feature_tensors_gradient(self, op_name):
        ...
        workspace.FeedBlob('in2_lengths', np.array([2, 2], dtype=np.int32))
        workspace.FeedBlob('in2_presence', np.array([True, True], dtype=np.bool))
        workspace.FeedBlob('out_values_values_grad', np.array([11.1, 11.2, 12.1, 12.2, 12.3, 12.4], dtype=np.float))
        workspace.RunOperatorOnce(op)
        np.testing.assert_array_equal(workspace.FetchBlob('in1_values_grad'), np.array([11.1, 11.2], dtype=np.float))
        np.testing.assert_array_equal(workspace.FetchBlob('in2_values_grad'), np.array([12.1, 12.2, 12.3, 12.4], dtype=np.float))
    ...
    def test_merge_multi_scalar_feature_tensors(self):
        ...
        workspace.FeedBlob('in1_values', np.array([11.0, 12.0, 13.0], dtype=np.float))
        workspace.FeedBlob('in2_lengths', np.array([2, 1], dtype=np.int32))
        workspace.FeedBlob('in2_keys', np.array([14, 15, 16], dtype=np.int64))
        workspace.FeedBlob('in2_values', np.array([14.0, 15.0, 16.0], dtype=np.float))
        workspace.RunOperatorOnce(op)
        ...
        np.testing.assert_array_equal(workspace.FetchBlob('out_values'), np.array([11.0, 14.0, 15.0, 12.0, 13.0, 16.0], dtype=np.float))
    ...
    def test_merge_multi_scalar_feature_tensors_gradient(self):
        ...
        workspace.FeedBlob('out_values_grad', np.array([11.0, 14.0, 15.0, 12.0, 13.0, 16.0, 17.0], dtype=np.float))
        workspace.RunOperatorOnce(op)
        np.testing.assert_array_equal(workspace.FetchBlob('in1_values_grad'), np.array([11.0, 12.0, 13.0], dtype=np.float))
        np.testing.assert_array_equal(workspace.FetchBlob('in2_values_grad'), np.array([14.0, 15.0, 16.0, 17.0], dtype=np.float))
    ...
    def test_merge_multi_list_feature_tensors(self):
        ...
        workspace.FeedBlob('in1_values_values', np.array([11.1, 11.2, 12.1, 12.2, 13.1, 13.2], dtype=np.float))
        workspace.FeedBlob('in2_lengths', np.array([2, 1], dtype=np.int32))
        workspace.FeedBlob('in2_keys', np.array([14, 15, 16], dtype=np.int64))
        workspace.FeedBlob('in2_values_lengths', np.array([2, 2, 2], dtype=np.int32))
        workspace.FeedBlob('in2_values_values', np.array([14.1, 14.2, 15.1, 15.2, 16.1, 16.2], dtype=np.float))
        workspace.RunOperatorOnce(op)
        np.testing.assert_array_equal(workspace.FetchBlob('out_lengths'), np.array([3, 3], dtype=np.int32))
        np.testing.assert_array_equal(workspace.FetchBlob('out_keys'), np.array([11, 14, 15, 12, 13, 16], dtype=np.int64))
        np.testing.assert_array_equal(workspace.FetchBlob('out_values_lengths'), np.array([2, 2, 2, 2, 2, 2], dtype=np.int32))
        np.testing.assert_array_equal(workspace.FetchBlob('out_values_values'), np.array([11.1, 11.2, 14.1, 14.2, 15.1, 15.2, 12.1, 12.2, 13.1, 13.2, 16.1, 16.2], dtype=np.float))
    ...
    def _test_merge_multi_list_or_map_feature_tensors_gradient(self, op_name):
        ...
        workspace.FeedBlob('in2_lengths', np.array([2, 1], dtype=np.int32))
        workspace.FeedBlob('in2_values_lengths', np.array([2, 2, 2], dtype=np.int32))
        workspace.FeedBlob('out_values_values_grad', np.array([11.1, 11.2, 14.1, 14.2, 15.1, 15.2, 12.1, 12.2, 13.1, 13.2, 16.1, 16.2], dtype=np.float))
        workspace.RunOperatorOnce(op)
        np.testing.assert_array_equal(workspace.FetchBlob('in1_values_values_grad'), np.array([11.1, 11.2, 12.1, 12.2, 13.1, 13.2], dtype=np.float))
        np.testing.assert_array_equal(workspace.FetchBlob('in2_values_values_grad'), np.array([14.1, 14.2, 15.1, 15.2, 16.1, 16.2], dtype=np.float))
