...
class TestChannelStatsOp(serial.SerializedTestCase):
    ...
    @serial.given(N=st.integers(1, 5), C=st.integers(1, 10), H=st.integers(1, 12), W=st.integers(1, 12), order=st.sampled_from(['NCHW', 'NHWC']), **hu.gcs)
    ...
    @serial.given(N=st.integers(1, 5), C=st.integers(1, 10), D=st.integers(1, 6), H=st.integers(1, 6), W=st.integers(1, 6), order=st.sampled_from(['NCHW', 'NHWC']), **hu.gcs)
