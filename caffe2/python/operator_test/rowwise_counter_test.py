...
def update_counter_ref(prev_iter, update_counter, indices, curr_iter, counter_halflife):
    ...
    return custom_funtemplate.rewrite_template('caffe2.python.operator_test.rowwise_counter_test.update_counter_ref', 'update_counter_ref(prev_iter, update_counter, indices, curr_iter, counter_halflife)', {'np': np, 'prev_iter': prev_iter, 'update_counter': update_counter, 'indices': indices, 'curr_iter': curr_iter, 'counter_halflife': counter_halflife}, 2)
