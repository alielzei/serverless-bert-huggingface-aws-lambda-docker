...
def compare_rowwise(emb_orig, emb_reconstructed, fp16):
    ...
    custom_funtemplate.rewrite_template('caffe2.python.lengths_reducer_fused_8bit_rowwise_ops_test.compare_rowwise', 'compare_rowwise(emb_orig, emb_reconstructed, fp16)', {'np': np, 'emb_orig': emb_orig, 'emb_reconstructed': emb_reconstructed, 'fp16': fp16}, 0)
